...
|------------- | ------------- | -------------|
| [**getByAccountId**](BeneficiariesApi.md#getByAccountId) | **GET** /accounts/{AccountId}/beneficiaries | Get Account Beneficiaries |


<a name="getByAccountId"></a>
# **getByAccountId**
> OBReadBeneficiary5 getByAccountId(accountId).xFapiAuthDate(xFapiAuthDate).xFapiCustomerIpAddress(xFapiCustomerIpAddress).xFapiInteractionId(xFapiInteractionId).xCustomerUserAgent(xCustomerUserAgent).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      OBReadBeneficiary5 result = client
              .beneficiaries
      ...
      System.err.println("Exception when calling BeneficiariesApi#getByAccountId");
    ...
    try {
      ApiResponse<OBReadBeneficiary5> response = client
              .beneficiaries
              .getByAccountId(accountId)
              .xFapiAuthDate(xFapiAuthDate)
              .xFapiCustomerIpAddress(xFapiCustomerIpAddress)

...
|**otherFeeType** | [**List&lt;OtherFeeTypePropertyInner1&gt;**](OtherFeeTypePropertyInner1.md) | Other fee type code which is not available in the standard code set |  [optional] |

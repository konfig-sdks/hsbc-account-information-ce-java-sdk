...
public class ProductDetailsProperty {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "10", value = "The length/duration of the fee free period")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "DAY", value = "The unit of period (days, weeks, months etc.) of the promotional length")
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.segment, productDetailsProperty.segment) &&
        Objects.equals(this.feeFreeLength, productDetailsProperty.feeFreeLength) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(segment, feeFreeLength, feeFreeLengthPeriod, notes, additionalProperties);
  }

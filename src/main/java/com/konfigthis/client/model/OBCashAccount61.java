 ...
 */
@ApiModel(description = "Unambiguous identification of the account of the debtor, in the case of a crebit transaction.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class OBCashAccount61 {
 ...
 public enum SchemeNameEnum {
  ...
  public OBCashAccount61 schemeName(SchemeNameEnum schemeName) {
  ...
  **/
  ...
  @ApiModelProperty(example = "UK_OBIE_BBAN", value = "Name of the identification scheme, in a coded form as published in an external list.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Sample Identyfication0", value = "Identification assigned by an institution to identify an account. This identification is known by the account owner.")
  ...
  **/
   ...
   * @return the OBCashAccount61 instance itself
   */
  public OBCashAccount61 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.schemeName, obCashAccount61.schemeName) &&
        ...
        Objects.equals(this.additionalProperties, obCashAccount61.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to OBCashAccount61
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OBCashAccount61.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OBCashAccount61 is not found in the empty JSON string", OBCashAccount61.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OBCashAccount61.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OBCashAccount61' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OBCashAccount61> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OBCashAccount61.class));

       return (TypeAdapter<T>) new TypeAdapter<OBCashAccount61>() {
           @Override
           public void write(JsonWriter out, OBCashAccount61 value) throws IOException {
           ...
           @Override
           public OBCashAccount61 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OBCashAccount61 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OBCashAccount61 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OBCashAccount61
  * @throws IOException if the JSON string is invalid with respect to OBCashAccount61
  */
  public static OBCashAccount61 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OBCashAccount61.class);
  }

 /**
  * Convert an instance of OBCashAccount61 to an JSON string
  *
  * @return JSON string
  */

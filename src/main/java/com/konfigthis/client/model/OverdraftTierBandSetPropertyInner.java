...
public class OverdraftTierBandSetPropertyInner {
  ...
  **/
  ...
  @ApiModelProperty(example = "BANDED", required = true, value = "The methodology of how overdraft is charged. It can be: 'Whole'  Where the same charge/rate is applied to the entirety of the overdraft balance (where charges are applicable).  'Tiered' Where different charges/rates are applied dependent on overdraft maximum and minimum balance amount tiers defined by the lending financial organisation 'Banded' Where different charges/rates are applied dependent on overdraft maximum and minimum balance amount bands defined by a government organisation.")
  ...
  **/
  ...
  @ApiModelProperty(example = "COMMITTED", value = "An overdraft can either be 'committed' which means that the facility cannot be withdrawn without reasonable notification before it's agreed end date, or 'on demand' which means that the financial institution can demand repayment at any point in time.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "idstring", value = "Unique and unambiguous identification of a  Tier Band for a overdraft product.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "100", value = "When a customer exceeds their credit limit, a financial institution will not charge the customer unauthorised overdraft charges if they do not exceed by more than the buffer amount. Note: Authorised overdraft charges may still apply.")
  ...
  **/
  ...
  public OverdraftTierBandSetPropertyInner overdraftFeesCharges(List<OverdraftFeesChargesPropertyInner1> overdraftFeesCharges) {
  ...
  public OverdraftTierBandSetPropertyInner addOverdraftFeesChargesItem(OverdraftFeesChargesPropertyInner1 overdraftFeesChargesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tierBandMethod, overdraftTierBandSetPropertyInner.tierBandMethod) &&
        ...
        Objects.equals(this.authorisedIndicator, overdraftTierBandSetPropertyInner.authorisedIndicator) &&

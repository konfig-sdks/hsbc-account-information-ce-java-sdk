...
import com.konfigthis.client.model.OtherFeeTypeProperty4Inner1;
...
public class OverdraftFeeChargeCapProperty1Inner {
  /**
   * Overdraft fee type
   */
 ...
 public enum CappingPeriodEnum {
  ...
  private List<OtherFeeTypeProperty4Inner1> otherFeeType = null;

  public OverdraftFeeChargeCapProperty1Inner() {
  }

  public OverdraftFeeChargeCapProperty1Inner feeType(List<FeeTypeEnum> feeType) {
  ...
  public OverdraftFeeChargeCapProperty1Inner addFeeTypeItem(FeeTypeEnum feeTypeItem) {
  ...
  **/
  ...
  public OverdraftFeeChargeCapProperty1Inner overdraftControlIndicator(Boolean overdraftControlIndicator) {
  ...
  **/
  ...
  public OverdraftFeeChargeCapProperty1Inner minMaxType(MinMaxTypeEnum minMaxType) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "test value", required = true, value = "Indicates that this is the minimum/ maximum fee/charge that can be applied by the financial institution")
  ...
  public OverdraftFeeChargeCapProperty1Inner feeCapOccurrence(Float feeCapOccurrence) {
  ...
  **/
  ...
  public OverdraftFeeChargeCapProperty1Inner feeCapAmount(String feeCapAmount) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "test value", value = "Cap amount charged for a fee/charge")
  ...
  public OverdraftFeeChargeCapProperty1Inner cappingPeriod(CappingPeriodEnum cappingPeriod) {
  ...
  **/
  ...
  public OverdraftFeeChargeCapProperty1Inner notes(List<String> notes) {
  ...
  public OverdraftFeeChargeCapProperty1Inner addNotesItem(String notesItem) {
    if (this.notes == null) {
  ...
  **/
  ...
  public OverdraftFeeChargeCapProperty1Inner otherFeeType(List<OtherFeeTypeProperty4Inner1> otherFeeType) {
  ...
  public OverdraftFeeChargeCapProperty1Inner addOtherFeeTypeItem(OtherFeeTypeProperty4Inner1 otherFeeTypeItem) {
  ...
  **/
  ...
  public List<OtherFeeTypeProperty4Inner1> getOtherFeeType() {
    return otherFeeType;
  }


  public void setOtherFeeType(List<OtherFeeTypeProperty4Inner1> otherFeeType) {
   ...
   * @return the OverdraftFeeChargeCapProperty1Inner instance itself
   */
  public OverdraftFeeChargeCapProperty1Inner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OverdraftFeeChargeCapProperty1Inner overdraftFeeChargeCapProperty1Inner = (OverdraftFeeChargeCapProperty1Inner) o;
    return Objects.equals(this.feeType, overdraftFeeChargeCapProperty1Inner.feeType) &&
        Objects.equals(this.overdraftControlIndicator, overdraftFeeChargeCapProperty1Inner.overdraftControlIndicator) &&
        Objects.equals(this.minMaxType, overdraftFeeChargeCapProperty1Inner.minMaxType) &&
        Objects.equals(this.feeCapOccurrence, overdraftFeeChargeCapProperty1Inner.feeCapOccurrence) &&
        Objects.equals(this.feeCapAmount, overdraftFeeChargeCapProperty1Inner.feeCapAmount) &&
        Objects.equals(this.cappingPeriod, overdraftFeeChargeCapProperty1Inner.cappingPeriod) &&
        Objects.equals(this.notes, overdraftFeeChargeCapProperty1Inner.notes) &&
        Objects.equals(this.otherFeeType, overdraftFeeChargeCapProperty1Inner.otherFeeType)&&
        Objects.equals(this.additionalProperties, overdraftFeeChargeCapProperty1Inner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class OverdraftFeeChargeCapProperty1Inner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to OverdraftFeeChargeCapProperty1Inner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OverdraftFeeChargeCapProperty1Inner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OverdraftFeeChargeCapProperty1Inner is not found in the empty JSON string", OverdraftFeeChargeCapProperty1Inner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OverdraftFeeChargeCapProperty1Inner.openapiRequiredFields) {
      ...
      if (jsonObj.get("OtherFeeType") != null && !jsonObj.get("OtherFeeType").isJsonNull()) {
        ...
        if (jsonArrayotherFeeType != null) {
          ...
          for (int i = 0; i < jsonArrayotherFeeType.size(); i++) {
            OtherFeeTypeProperty4Inner1.validateJsonObject(jsonArrayotherFeeType.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OverdraftFeeChargeCapProperty1Inner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OverdraftFeeChargeCapProperty1Inner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OverdraftFeeChargeCapProperty1Inner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OverdraftFeeChargeCapProperty1Inner.class));

       return (TypeAdapter<T>) new TypeAdapter<OverdraftFeeChargeCapProperty1Inner>() {
           @Override
           public void write(JsonWriter out, OverdraftFeeChargeCapProperty1Inner value) throws IOException {
           ...
           @Override
           public OverdraftFeeChargeCapProperty1Inner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OverdraftFeeChargeCapProperty1Inner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OverdraftFeeChargeCapProperty1Inner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OverdraftFeeChargeCapProperty1Inner
  * @throws IOException if the JSON string is invalid with respect to OverdraftFeeChargeCapProperty1Inner
  */
  public static OverdraftFeeChargeCapProperty1Inner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OverdraftFeeChargeCapProperty1Inner.class);
  }

 /**
  * Convert an instance of OverdraftFeeChargeCapProperty1Inner to an JSON string
  *
  * @return JSON string
  */

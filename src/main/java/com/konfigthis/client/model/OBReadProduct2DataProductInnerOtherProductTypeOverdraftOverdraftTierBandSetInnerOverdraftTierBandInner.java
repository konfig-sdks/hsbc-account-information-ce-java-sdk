...
public class OBReadProduct2DataProductInnerOtherProductTypeOverdraftOverdraftTierBandSetInnerOverdraftTierBandInner {
  ...
  **/
  ...
  @ApiModelProperty(example = "test value", value = "Unique and unambiguous identification of a  Tier Band for a overdraft.")
  ...
  **/
  ...
  @ApiModelProperty(example = "test value", required = true, value = "Minimum value of Overdraft Tier/Band")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "test value", value = "Maximum value of Overdraft Tier/Band")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "test value", value = "EAR means Effective Annual Rate and/or Equivalent Annual Rate (frequently used interchangeably), being the actual annual interest rate of an Overdraft.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "test value", value = "Specifies the period of a fixed length overdraft agreement")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "test value", value = "Refers to which interest rate is applied when interests are tiered. For example, if an overdraft balance is �2k and the interest tiers are:- 0-�500 0.1%, 500-1000 0.2%, 1000-10000 0.5%, then the applicable interest rate could either be 0.5% of the entire balance (since the account balance sits in the top interest tier) or (0.1%*500)+(0.2%*500)+(0.5%*1000). In the 1st situation, we say the interest is applied to the �Whole� of the account balance,  and in the 2nd that it is �Tiered�.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(identification, tierValueMin, tierValueMax, EAR, agreementLengthMin, agreementLengthMax, agreementPeriod, overdraftInterestChargingCoverage, bankGuaranteedIndicator, notes, overdraftFeesCharges, additionalProperties);
  }

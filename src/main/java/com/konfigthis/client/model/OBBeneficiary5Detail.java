...
public class OBBeneficiary5Detail {
  ...
  **/
   ...
   * @return the OBBeneficiary5Detail instance itself
   */
  public OBBeneficiary5Detail putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountId, obBeneficiary5Detail.accountId) &&
        ...
        Objects.equals(this.additionalProperties, obBeneficiary5Detail.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountId, beneficiaryId, beneficiaryType, reference, supplementaryData, creditorAgent, creditorAccount, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to OBBeneficiary5Detail
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OBBeneficiary5Detail.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OBBeneficiary5Detail is not found in the empty JSON string", OBBeneficiary5Detail.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OBBeneficiary5Detail.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OBBeneficiary5Detail.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OBBeneficiary5Detail' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OBBeneficiary5Detail> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OBBeneficiary5Detail.class));

       return (TypeAdapter<T>) new TypeAdapter<OBBeneficiary5Detail>() {
           @Override
           public void write(JsonWriter out, OBBeneficiary5Detail value) throws IOException {
           ...
           @Override
           public OBBeneficiary5Detail read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OBBeneficiary5Detail instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OBBeneficiary5Detail given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OBBeneficiary5Detail
  * @throws IOException if the JSON string is invalid with respect to OBBeneficiary5Detail
  */
  public static OBBeneficiary5Detail fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OBBeneficiary5Detail.class);
  }

 /**
  * Convert an instance of OBBeneficiary5Detail to an JSON string
  *
  * @return JSON string
  */

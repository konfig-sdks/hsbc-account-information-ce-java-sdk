...
public class OBReadProduct2DataProductInnerOtherProductTypeRepayment {
  ...
  **/
  ...
  @ApiModelProperty(example = "USBA", value = "Repayment type")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "SMDA", value = "Repayment frequency")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "RABD", value = "The repayment is for paying just the interest only or both interest and capital or bullet amount or balance to date etc")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(repaymentType, repaymentFrequency, amountType, notes, otherRepaymentType, otherRepaymentFrequency, otherAmountType, repaymentFeeCharges, repaymentHoliday, additionalProperties);
  }

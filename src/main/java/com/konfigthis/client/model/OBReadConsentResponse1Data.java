...
public class OBReadConsentResponse1Data {
  ...
  **/
  ...
  @ApiModelProperty(example = "699588e-b5c9-48d5-b0fc-00d52b229f7d", required = true, value = "Unique identification as assigned to identify the account access consent resource.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "AUTHORISED", required = true, value = "Specifies the status of consent resource in code form.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "2023-01-04T00:00Z", required = true, value = "Date and time at which the resource status was updated.All dates in the JSON payloads are represented in ISO 8601 date-time format.  All date-time fields in responses must include the timezone. An example is below: 2017-04-05T10:43:07+00:00")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(consentId, creationDateTime, status, statusUpdateDateTime, permissions, expirationDateTime, transactionFromDateTime, transactionToDateTime, additionalProperties);
  }

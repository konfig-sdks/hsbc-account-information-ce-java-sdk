 ...
 */
@ApiModel(description = "Links relevant to the payload")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Links {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "A link to the same resource used for the current request.")

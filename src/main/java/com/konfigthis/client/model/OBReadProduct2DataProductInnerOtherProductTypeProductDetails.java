...
public class OBReadProduct2DataProductInnerOtherProductTypeProductDetails {
 ...
 public enum FeeFreeLengthPeriodEnum {
  ...
  public OBReadProduct2DataProductInnerOtherProductTypeProductDetails() {
  }
  ...
  **/
   ...
   * @return the OBReadProduct2DataProductInnerOtherProductTypeProductDetails instance itself
   */
  public OBReadProduct2DataProductInnerOtherProductTypeProductDetails putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.segment, obReadProduct2DataProductInnerOtherProductTypeProductDetails.segment) &&
        ...
        Objects.equals(this.additionalProperties, obReadProduct2DataProductInnerOtherProductTypeProductDetails.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(segment, feeFreeLength, feeFreeLengthPeriod, monthlyMaximumCharge, notes, otherSegment, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("MonthlyMaximumCharge");
  ...
  * @throws IOException if the JSON Object is invalid with respect to OBReadProduct2DataProductInnerOtherProductTypeProductDetails
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OBReadProduct2DataProductInnerOtherProductTypeProductDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OBReadProduct2DataProductInnerOtherProductTypeProductDetails is not found in the empty JSON string", OBReadProduct2DataProductInnerOtherProductTypeProductDetails.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("MonthlyMaximumCharge") != null && !jsonObj.get("MonthlyMaximumCharge").isJsonNull()) && !jsonObj.get("MonthlyMaximumCharge").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `MonthlyMaximumCharge` to be a primitive type in the JSON string but got `%s`", jsonObj.get("MonthlyMaximumCharge").toString()));
      }
      // ensure the optional json data is an array if present
      if (jsonObj.get("Notes") != null && !jsonObj.get("Notes").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `Notes` to be an array in the JSON string but got `%s`", jsonObj.get("Notes").toString()));
      }
      // validate the optional field `OtherSegment`
      if (jsonObj.get("OtherSegment") != null && !jsonObj.get("OtherSegment").isJsonNull()) {
        OBOtherCodeType10.validateJsonObject(jsonObj.getAsJsonObject("OtherSegment"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OBReadProduct2DataProductInnerOtherProductTypeProductDetails.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OBReadProduct2DataProductInnerOtherProductTypeProductDetails' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OBReadProduct2DataProductInnerOtherProductTypeProductDetails> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OBReadProduct2DataProductInnerOtherProductTypeProductDetails.class));

       return (TypeAdapter<T>) new TypeAdapter<OBReadProduct2DataProductInnerOtherProductTypeProductDetails>() {
           @Override
           public void write(JsonWriter out, OBReadProduct2DataProductInnerOtherProductTypeProductDetails value) throws IOException {
           ...
           @Override
           public OBReadProduct2DataProductInnerOtherProductTypeProductDetails read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OBReadProduct2DataProductInnerOtherProductTypeProductDetails instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OBReadProduct2DataProductInnerOtherProductTypeProductDetails given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OBReadProduct2DataProductInnerOtherProductTypeProductDetails
  * @throws IOException if the JSON string is invalid with respect to OBReadProduct2DataProductInnerOtherProductTypeProductDetails
  */
  public static OBReadProduct2DataProductInnerOtherProductTypeProductDetails fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OBReadProduct2DataProductInnerOtherProductTypeProductDetails.class);
  }

 /**
  * Convert an instance of OBReadProduct2DataProductInnerOtherProductTypeProductDetails to an JSON string
  *
  * @return JSON string
  */

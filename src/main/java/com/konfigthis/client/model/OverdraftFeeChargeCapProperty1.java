...
import com.konfigthis.client.model.OtherFeeTypeProperty5Inner;
...
public class OverdraftFeeChargeCapProperty1 {
  /**
   * Overdraft fee type
   */
 ...
 public enum CappingPeriodEnum {
  ...
  private List<OtherFeeTypeProperty5Inner> otherFeeType = null;

  public OverdraftFeeChargeCapProperty1() {
  }

  public OverdraftFeeChargeCapProperty1 feeType(List<FeeTypeEnum> feeType) {
  ...
  public OverdraftFeeChargeCapProperty1 addFeeTypeItem(FeeTypeEnum feeTypeItem) {
  ...
  **/
  ...
  public OverdraftFeeChargeCapProperty1 overdraftControlIndicator(Boolean overdraftControlIndicator) {
  ...
  **/
  ...
  public OverdraftFeeChargeCapProperty1 minMaxType(MinMaxTypeEnum minMaxType) {
  ...
  **/
  ...
  public OverdraftFeeChargeCapProperty1 feeCapOccurrence(Float feeCapOccurrence) {
  ...
  **/
  ...
  public OverdraftFeeChargeCapProperty1 feeCapAmount(String feeCapAmount) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "100.00", value = "Cap amount charged for a fee/charge")
  ...
  public OverdraftFeeChargeCapProperty1 cappingPeriod(CappingPeriodEnum cappingPeriod) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "YEAR", value = "Period e.g. day, week, month etc. for which the fee/charge is capped")
  ...
  public OverdraftFeeChargeCapProperty1 notes(List<String> notes) {
  ...
  public OverdraftFeeChargeCapProperty1 addNotesItem(String notesItem) {
    if (this.notes == null) {
  ...
  **/
  ...
  public OverdraftFeeChargeCapProperty1 otherFeeType(List<OtherFeeTypeProperty5Inner> otherFeeType) {
  ...
  public OverdraftFeeChargeCapProperty1 addOtherFeeTypeItem(OtherFeeTypeProperty5Inner otherFeeTypeItem) {
  ...
  **/
  ...
  public List<OtherFeeTypeProperty5Inner> getOtherFeeType() {
    return otherFeeType;
  }


  public void setOtherFeeType(List<OtherFeeTypeProperty5Inner> otherFeeType) {
   ...
   * @return the OverdraftFeeChargeCapProperty1 instance itself
   */
  public OverdraftFeeChargeCapProperty1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OverdraftFeeChargeCapProperty1 overdraftFeeChargeCapProperty1 = (OverdraftFeeChargeCapProperty1) o;
    return Objects.equals(this.feeType, overdraftFeeChargeCapProperty1.feeType) &&
        Objects.equals(this.overdraftControlIndicator, overdraftFeeChargeCapProperty1.overdraftControlIndicator) &&
        Objects.equals(this.minMaxType, overdraftFeeChargeCapProperty1.minMaxType) &&
        Objects.equals(this.feeCapOccurrence, overdraftFeeChargeCapProperty1.feeCapOccurrence) &&
        Objects.equals(this.feeCapAmount, overdraftFeeChargeCapProperty1.feeCapAmount) &&
        Objects.equals(this.cappingPeriod, overdraftFeeChargeCapProperty1.cappingPeriod) &&
        Objects.equals(this.notes, overdraftFeeChargeCapProperty1.notes) &&
        Objects.equals(this.otherFeeType, overdraftFeeChargeCapProperty1.otherFeeType)&&
        Objects.equals(this.additionalProperties, overdraftFeeChargeCapProperty1.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class OverdraftFeeChargeCapProperty1 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to OverdraftFeeChargeCapProperty1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OverdraftFeeChargeCapProperty1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OverdraftFeeChargeCapProperty1 is not found in the empty JSON string", OverdraftFeeChargeCapProperty1.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OverdraftFeeChargeCapProperty1.openapiRequiredFields) {
      ...
      if (jsonObj.get("OtherFeeType") != null && !jsonObj.get("OtherFeeType").isJsonNull()) {
        ...
        if (jsonArrayotherFeeType != null) {
          ...
          for (int i = 0; i < jsonArrayotherFeeType.size(); i++) {
            OtherFeeTypeProperty5Inner.validateJsonObject(jsonArrayotherFeeType.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OverdraftFeeChargeCapProperty1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OverdraftFeeChargeCapProperty1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OverdraftFeeChargeCapProperty1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OverdraftFeeChargeCapProperty1.class));

       return (TypeAdapter<T>) new TypeAdapter<OverdraftFeeChargeCapProperty1>() {
           @Override
           public void write(JsonWriter out, OverdraftFeeChargeCapProperty1 value) throws IOException {
           ...
           @Override
           public OverdraftFeeChargeCapProperty1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OverdraftFeeChargeCapProperty1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OverdraftFeeChargeCapProperty1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OverdraftFeeChargeCapProperty1
  * @throws IOException if the JSON string is invalid with respect to OverdraftFeeChargeCapProperty1
  */
  public static OverdraftFeeChargeCapProperty1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OverdraftFeeChargeCapProperty1.class);
  }

 /**
  * Convert an instance of OverdraftFeeChargeCapProperty1 to an JSON string
  *
  * @return JSON string
  */

...
import com.konfigthis.client.model.OtherApplicationFrequencyProperty2;
import com.konfigthis.client.model.OtherCalculationFrequencyProperty2;
import com.konfigthis.client.model.OtherFeeRateTypeProperty1;
import com.konfigthis.client.model.OtherFeeTypeProperty1;
import com.konfigthis.client.model.OverdraftFeeChargeCapPropertyInner3;
...
public class OverdraftFeeChargeDetailPropertyInner1 {
  /**
   * Overdraft fee type
   */
 ...
 public enum CalculationFrequencyEnum {
  ...
  private List<OverdraftFeeChargeCapPropertyInner3> overdraftFeeChargeCap = null;
  ...
  private OtherApplicationFrequencyProperty2 otherApplicationFrequency;
  ...
  private OtherCalculationFrequencyProperty2 otherCalculationFrequency;

  public OverdraftFeeChargeDetailPropertyInner1() {
  }

  public OverdraftFeeChargeDetailPropertyInner1 feeType(FeeTypeEnum feeType) {
  ...
  **/
  ...
  public OverdraftFeeChargeDetailPropertyInner1 negotiableIndicator(Boolean negotiableIndicator) {
  ...
  **/
  ...
  @ApiModelProperty(example = "true", value = "Indicates whether fee and charges are negotiable")
  ...
  public OverdraftFeeChargeDetailPropertyInner1 overdraftControlIndicator(Boolean overdraftControlIndicator) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "true", value = "Indicates if the fee/charge is already covered by an 'Overdraft Control' fee or not.")
  ...
  public OverdraftFeeChargeDetailPropertyInner1 incrementalBorrowingAmount(String incrementalBorrowingAmount) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "0", value = "Every additional tranche of an overdraft balance to which an overdraft fee is applied")
  ...
  public OverdraftFeeChargeDetailPropertyInner1 feeAmount(String feeAmount) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "0", value = "Amount charged for an overdraft fee/charge (where it is charged in terms of an amount rather than a rate)")
  ...
  public OverdraftFeeChargeDetailPropertyInner1 feeRate(String feeRate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "0", value = "Rate charged for overdraft fee/charge (where it is charged in terms of a rate rather than an amount)")
  ...
  public OverdraftFeeChargeDetailPropertyInner1 feeRateType(FeeRateTypeEnum feeRateType) {
  ...
  **/
  ...
  public OverdraftFeeChargeDetailPropertyInner1 applicationFrequency(ApplicationFrequencyEnum applicationFrequency) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "YEARLY", required = true, value = "Frequency at which the overdraft charge is applied to the account")
  ...
  public OverdraftFeeChargeDetailPropertyInner1 calculationFrequency(CalculationFrequencyEnum calculationFrequency) {
  ...
  **/
  ...
  public OverdraftFeeChargeDetailPropertyInner1 notes(List<String> notes) {
  ...
  public OverdraftFeeChargeDetailPropertyInner1 addNotesItem(String notesItem) {
    if (this.notes == null) {
  ...
  **/
  ...
  public OverdraftFeeChargeDetailPropertyInner1 overdraftFeeChargeCap(List<OverdraftFeeChargeCapPropertyInner3> overdraftFeeChargeCap) {
  ...
  public OverdraftFeeChargeDetailPropertyInner1 addOverdraftFeeChargeCapItem(OverdraftFeeChargeCapPropertyInner3 overdraftFeeChargeCapItem) {
  ...
  **/
  ...
  public List<OverdraftFeeChargeCapPropertyInner3> getOverdraftFeeChargeCap() {
    return overdraftFeeChargeCap;
  }


  public void setOverdraftFeeChargeCap(List<OverdraftFeeChargeCapPropertyInner3> overdraftFeeChargeCap) {
  ...
  public OverdraftFeeChargeDetailPropertyInner1 otherFeeType(OtherFeeTypeProperty1 otherFeeType) {
  ...
  **/
  ...
  public OverdraftFeeChargeDetailPropertyInner1 otherFeeRateType(OtherFeeRateTypeProperty1 otherFeeRateType) {
  ...
  **/
  ...
  public OverdraftFeeChargeDetailPropertyInner1 otherApplicationFrequency(OtherApplicationFrequencyProperty2 otherApplicationFrequency) {
  ...
  **/
  ...
  public OtherApplicationFrequencyProperty2 getOtherApplicationFrequency() {
    return otherApplicationFrequency;
  }


  public void setOtherApplicationFrequency(OtherApplicationFrequencyProperty2 otherApplicationFrequency) {
  ...
  public OverdraftFeeChargeDetailPropertyInner1 otherCalculationFrequency(OtherCalculationFrequencyProperty2 otherCalculationFrequency) {
  ...
  **/
  ...
  public OtherCalculationFrequencyProperty2 getOtherCalculationFrequency() {
    return otherCalculationFrequency;
  }


  public void setOtherCalculationFrequency(OtherCalculationFrequencyProperty2 otherCalculationFrequency) {
   ...
   * @return the OverdraftFeeChargeDetailPropertyInner1 instance itself
   */
  public OverdraftFeeChargeDetailPropertyInner1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OverdraftFeeChargeDetailPropertyInner1 overdraftFeeChargeDetailPropertyInner1 = (OverdraftFeeChargeDetailPropertyInner1) o;
    return Objects.equals(this.feeType, overdraftFeeChargeDetailPropertyInner1.feeType) &&
        Objects.equals(this.negotiableIndicator, overdraftFeeChargeDetailPropertyInner1.negotiableIndicator) &&
        Objects.equals(this.overdraftControlIndicator, overdraftFeeChargeDetailPropertyInner1.overdraftControlIndicator) &&
        Objects.equals(this.incrementalBorrowingAmount, overdraftFeeChargeDetailPropertyInner1.incrementalBorrowingAmount) &&
        Objects.equals(this.feeAmount, overdraftFeeChargeDetailPropertyInner1.feeAmount) &&
        Objects.equals(this.feeRate, overdraftFeeChargeDetailPropertyInner1.feeRate) &&
        Objects.equals(this.feeRateType, overdraftFeeChargeDetailPropertyInner1.feeRateType) &&
        Objects.equals(this.applicationFrequency, overdraftFeeChargeDetailPropertyInner1.applicationFrequency) &&
        Objects.equals(this.calculationFrequency, overdraftFeeChargeDetailPropertyInner1.calculationFrequency) &&
        Objects.equals(this.notes, overdraftFeeChargeDetailPropertyInner1.notes) &&
        Objects.equals(this.overdraftFeeChargeCap, overdraftFeeChargeDetailPropertyInner1.overdraftFeeChargeCap) &&
        Objects.equals(this.otherFeeType, overdraftFeeChargeDetailPropertyInner1.otherFeeType) &&
        Objects.equals(this.otherFeeRateType, overdraftFeeChargeDetailPropertyInner1.otherFeeRateType) &&
        Objects.equals(this.otherApplicationFrequency, overdraftFeeChargeDetailPropertyInner1.otherApplicationFrequency) &&
        Objects.equals(this.otherCalculationFrequency, overdraftFeeChargeDetailPropertyInner1.otherCalculationFrequency)&&
        Objects.equals(this.additionalProperties, overdraftFeeChargeDetailPropertyInner1.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(feeType, negotiableIndicator, overdraftControlIndicator, incrementalBorrowingAmount, feeAmount, feeRate, feeRateType, applicationFrequency, calculationFrequency, notes, overdraftFeeChargeCap, otherFeeType, otherFeeRateType, otherApplicationFrequency, otherCalculationFrequency, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class OverdraftFeeChargeDetailPropertyInner1 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to OverdraftFeeChargeDetailPropertyInner1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OverdraftFeeChargeDetailPropertyInner1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OverdraftFeeChargeDetailPropertyInner1 is not found in the empty JSON string", OverdraftFeeChargeDetailPropertyInner1.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OverdraftFeeChargeDetailPropertyInner1.openapiRequiredFields) {
      ...
      if (jsonObj.get("OverdraftFeeChargeCap") != null && !jsonObj.get("OverdraftFeeChargeCap").isJsonNull()) {
        ...
        if (jsonArrayoverdraftFeeChargeCap != null) {
          ...
          for (int i = 0; i < jsonArrayoverdraftFeeChargeCap.size(); i++) {
            OverdraftFeeChargeCapPropertyInner3.validateJsonObject(jsonArrayoverdraftFeeChargeCap.get(i).getAsJsonObject());
          };
        }
      }
      ...
      if (jsonObj.get("OtherApplicationFrequency") != null && !jsonObj.get("OtherApplicationFrequency").isJsonNull()) {
        OtherApplicationFrequencyProperty2.validateJsonObject(jsonObj.getAsJsonObject("OtherApplicationFrequency"));
      }
      ...
      if (jsonObj.get("OtherCalculationFrequency") != null && !jsonObj.get("OtherCalculationFrequency").isJsonNull()) {
        OtherCalculationFrequencyProperty2.validateJsonObject(jsonObj.getAsJsonObject("OtherCalculationFrequency"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OverdraftFeeChargeDetailPropertyInner1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OverdraftFeeChargeDetailPropertyInner1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OverdraftFeeChargeDetailPropertyInner1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OverdraftFeeChargeDetailPropertyInner1.class));

       return (TypeAdapter<T>) new TypeAdapter<OverdraftFeeChargeDetailPropertyInner1>() {
           @Override
           public void write(JsonWriter out, OverdraftFeeChargeDetailPropertyInner1 value) throws IOException {
           ...
           @Override
           public OverdraftFeeChargeDetailPropertyInner1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OverdraftFeeChargeDetailPropertyInner1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OverdraftFeeChargeDetailPropertyInner1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OverdraftFeeChargeDetailPropertyInner1
  * @throws IOException if the JSON string is invalid with respect to OverdraftFeeChargeDetailPropertyInner1
  */
  public static OverdraftFeeChargeDetailPropertyInner1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OverdraftFeeChargeDetailPropertyInner1.class);
  }

 /**
  * Convert an instance of OverdraftFeeChargeDetailPropertyInner1 to an JSON string
  *
  * @return JSON string
  */

...
public class OBReadProduct2DataProductInnerOtherProductTypeOverdraft {
  ...
  **/
   ...
   * @return the OBReadProduct2DataProductInnerOtherProductTypeOverdraft instance itself
   */
  public OBReadProduct2DataProductInnerOtherProductTypeOverdraft putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.notes, obReadProduct2DataProductInnerOtherProductTypeOverdraft.notes) &&
        ...
        Objects.equals(this.additionalProperties, obReadProduct2DataProductInnerOtherProductTypeOverdraft.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to OBReadProduct2DataProductInnerOtherProductTypeOverdraft
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OBReadProduct2DataProductInnerOtherProductTypeOverdraft.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OBReadProduct2DataProductInnerOtherProductTypeOverdraft is not found in the empty JSON string", OBReadProduct2DataProductInnerOtherProductTypeOverdraft.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OBReadProduct2DataProductInnerOtherProductTypeOverdraft.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayoverdraftTierBandSet.size(); i++) {
        OBReadProduct2DataProductInnerOtherProductTypeOverdraftOverdraftTierBandSetInner.validateJsonObject(jsonArrayoverdraftTierBandSet.get(i).getAsJsonObject());
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OBReadProduct2DataProductInnerOtherProductTypeOverdraft.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OBReadProduct2DataProductInnerOtherProductTypeOverdraft' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OBReadProduct2DataProductInnerOtherProductTypeOverdraft> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OBReadProduct2DataProductInnerOtherProductTypeOverdraft.class));

       return (TypeAdapter<T>) new TypeAdapter<OBReadProduct2DataProductInnerOtherProductTypeOverdraft>() {
           @Override
           public void write(JsonWriter out, OBReadProduct2DataProductInnerOtherProductTypeOverdraft value) throws IOException {
           ...
           @Override
           public OBReadProduct2DataProductInnerOtherProductTypeOverdraft read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OBReadProduct2DataProductInnerOtherProductTypeOverdraft instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OBReadProduct2DataProductInnerOtherProductTypeOverdraft given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OBReadProduct2DataProductInnerOtherProductTypeOverdraft
  * @throws IOException if the JSON string is invalid with respect to OBReadProduct2DataProductInnerOtherProductTypeOverdraft
  */
  public static OBReadProduct2DataProductInnerOtherProductTypeOverdraft fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OBReadProduct2DataProductInnerOtherProductTypeOverdraft.class);
  }

 /**
  * Convert an instance of OBReadProduct2DataProductInnerOtherProductTypeOverdraft to an JSON string
  *
  * @return JSON string
  */

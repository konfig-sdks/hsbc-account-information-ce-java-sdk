...
public class OverdraftFeeChargeCapPropertyInner {
  /**
   * Overdraft fee type
   */
 ...
 public enum CappingPeriodEnum {
  ...
  public OverdraftFeeChargeCapPropertyInner() {
  }

  public OverdraftFeeChargeCapPropertyInner feeType(List<FeeTypeEnum> feeType) {
  ...
  public OverdraftFeeChargeCapPropertyInner addFeeTypeItem(FeeTypeEnum feeTypeItem) {
  ...
  **/
  ...
  @ApiModelProperty(example = "AnnualReview", required = true, value = "Fee/charge type which is being capped")
  ...
  public OverdraftFeeChargeCapPropertyInner minMaxType(MinMaxTypeEnum minMaxType) {
  ...
  **/
  ...
  public OverdraftFeeChargeCapPropertyInner feeCapOccurrence(Float feeCapOccurrence) {
  ...
  **/
  ...
  @ApiModelProperty(example = "0", value = "Indicates whether the advertised overdraft rate is guaranteed to be offered to a borrower by the bank e.g. if it’s part of a government scheme, or whether the rate may vary dependent on the applicant’s circumstances.")
  ...
  public OverdraftFeeChargeCapPropertyInner feeCapAmount(String feeCapAmount) {
  ...
  **/
  ...
  public OverdraftFeeChargeCapPropertyInner cappingPeriod(CappingPeriodEnum cappingPeriod) {
  ...
  **/
  ...
  public OverdraftFeeChargeCapPropertyInner notes(List<String> notes) {
  ...
  public OverdraftFeeChargeCapPropertyInner addNotesItem(String notesItem) {
    if (this.notes == null) {
  ...
  **/
  ...
  public OverdraftFeeChargeCapPropertyInner otherFeeType(List<OtherFeeTypePropertyInner> otherFeeType) {
  ...
  public OverdraftFeeChargeCapPropertyInner addOtherFeeTypeItem(OtherFeeTypePropertyInner otherFeeTypeItem) {
  ...
  **/
   ...
   * @return the OverdraftFeeChargeCapPropertyInner instance itself
   */
  public OverdraftFeeChargeCapPropertyInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OverdraftFeeChargeCapPropertyInner overdraftFeeChargeCapPropertyInner = (OverdraftFeeChargeCapPropertyInner) o;
    return Objects.equals(this.feeType, overdraftFeeChargeCapPropertyInner.feeType) &&
        Objects.equals(this.minMaxType, overdraftFeeChargeCapPropertyInner.minMaxType) &&
        Objects.equals(this.feeCapOccurrence, overdraftFeeChargeCapPropertyInner.feeCapOccurrence) &&
        Objects.equals(this.feeCapAmount, overdraftFeeChargeCapPropertyInner.feeCapAmount) &&
        Objects.equals(this.cappingPeriod, overdraftFeeChargeCapPropertyInner.cappingPeriod) &&
        Objects.equals(this.notes, overdraftFeeChargeCapPropertyInner.notes) &&
        Objects.equals(this.otherFeeType, overdraftFeeChargeCapPropertyInner.otherFeeType)&&
        Objects.equals(this.additionalProperties, overdraftFeeChargeCapPropertyInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class OverdraftFeeChargeCapPropertyInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to OverdraftFeeChargeCapPropertyInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OverdraftFeeChargeCapPropertyInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OverdraftFeeChargeCapPropertyInner is not found in the empty JSON string", OverdraftFeeChargeCapPropertyInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OverdraftFeeChargeCapPropertyInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OverdraftFeeChargeCapPropertyInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OverdraftFeeChargeCapPropertyInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OverdraftFeeChargeCapPropertyInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OverdraftFeeChargeCapPropertyInner.class));

       return (TypeAdapter<T>) new TypeAdapter<OverdraftFeeChargeCapPropertyInner>() {
           @Override
           public void write(JsonWriter out, OverdraftFeeChargeCapPropertyInner value) throws IOException {
           ...
           @Override
           public OverdraftFeeChargeCapPropertyInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OverdraftFeeChargeCapPropertyInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OverdraftFeeChargeCapPropertyInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OverdraftFeeChargeCapPropertyInner
  * @throws IOException if the JSON string is invalid with respect to OverdraftFeeChargeCapPropertyInner
  */
  public static OverdraftFeeChargeCapPropertyInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OverdraftFeeChargeCapPropertyInner.class);
  }

 /**
  * Convert an instance of OverdraftFeeChargeCapPropertyInner to an JSON string
  *
  * @return JSON string
  */

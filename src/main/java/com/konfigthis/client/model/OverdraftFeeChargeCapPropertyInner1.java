...
import com.konfigthis.client.model.OtherFeeTypePropertyInner1;
...
public class OverdraftFeeChargeCapPropertyInner1 {
 ...
 public enum CappingPeriodEnum {
  ...
  private List<OtherFeeTypePropertyInner1> otherFeeType = null;
  ...
  **/
  ...
  @ApiModelProperty(example = "0.25", value = "Indicates whether the advertised overdraft rate is guaranteed to be offered to a borrower by the bank e.g. if it’s part of a government scheme, or whether the rate may vary dependent on the applicant’s circumstances.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "33.1", value = "Cap amount charged for a fee/charge")
  ...
  **/
  ...
  public OverdraftFeeChargeCapPropertyInner1 otherFeeType(List<OtherFeeTypePropertyInner1> otherFeeType) {
  ...
  public OverdraftFeeChargeCapPropertyInner1 addOtherFeeTypeItem(OtherFeeTypePropertyInner1 otherFeeTypeItem) {
  ...
  **/
  ...
  public List<OtherFeeTypePropertyInner1> getOtherFeeType() {
    return otherFeeType;
  }


  public void setOtherFeeType(List<OtherFeeTypePropertyInner1> otherFeeType) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.feeType, overdraftFeeChargeCapPropertyInner1.feeType) &&
        ...
        Objects.equals(this.cappingPeriod, overdraftFeeChargeCapPropertyInner1.cappingPeriod) &&
      ...
      if (jsonObj.get("OtherFeeType") != null && !jsonObj.get("OtherFeeType").isJsonNull()) {
        ...
        if (jsonArrayotherFeeType != null) {
          ...
          for (int i = 0; i < jsonArrayotherFeeType.size(); i++) {
            OtherFeeTypePropertyInner1.validateJsonObject(jsonArrayotherFeeType.get(i).getAsJsonObject());
          };
        }
      }
  }

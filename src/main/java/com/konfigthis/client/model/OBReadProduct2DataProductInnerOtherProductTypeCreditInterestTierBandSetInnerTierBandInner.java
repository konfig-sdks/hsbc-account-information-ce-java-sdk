...
public class OBReadProduct2DataProductInnerOtherProductTypeCreditInterestTierBandSetInnerTierBandInner {
  ...
  **/
  ...
  @ApiModelProperty(example = "test value", value = "Unique and unambiguous identification of a  Tier Band for the Product.")
  ...
  **/
  ...
  @ApiModelProperty(example = "test value", required = true, value = "Minimum deposit value for which the credit interest tier applies.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "test value", value = "Maximum deposit value for which the credit interest tier applies.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "test value", value = "How often is credit interest calculated for the account.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "FQAT", required = true, value = "How often is interest applied to the Product for this tier/band i.e. how often the financial institution pays accumulated interest to the customer's account.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "INBA", value = "Amount on which Interest applied.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "test value", required = true, value = "The annual equivalent rate (AER) is interest that is calculated under the assumption that any interest paid is combined with the original balance and the next interest payment will be based on the slightly higher account balance. Overall, this means that interest can be compounded several times in a year depending on the number of times that interest payments are made.  Read more: Annual Equivalent Rate (AER) http://www.investopedia.com/terms/a/aer.asp#ixzz4gfR7IO1A")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "INBB", value = "Interest rate types, other than AER, which financial institutions may use to describe the annual interest rate payable to the account holder's account.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "test value", value = "Bank Interest for the product")

...
public class OBParty2 {
  ...
  private OBExternalLegalStructureType1Code legalStructure;
  ...
  private OBExternalAccountRole1Code accountRole;
  ...
  **/
  ...
  @ApiModelProperty(example = "PPA", required = true, value = "A unique and immutable identifier used to identify the customer resource. This identifier has no meaning to the account owner.")
  ...
  **/
  ...
  @ApiModelProperty(example = "example PartyNumber", value = "Number assigned by an agent to identify its customer.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "ABC", value = "Name by which a party is known and which is usually used to identify that party.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "PTTestB7003", value = "Specifies a character string with a maximum length of 350 characters.")
  ...
  public OBParty2 legalStructure(OBExternalLegalStructureType1Code legalStructure) {
  ...
  **/
  ...
  public OBExternalLegalStructureType1Code getLegalStructure() {
    return legalStructure;
  }


  public void setLegalStructure(OBExternalLegalStructureType1Code legalStructure) {
  ...
  **/
  ...
  public OBParty2 accountRole(OBExternalAccountRole1Code accountRole) {
  ...
  **/
  ...
  public OBExternalAccountRole1Code getAccountRole() {
    return accountRole;
  }


  public void setAccountRole(OBExternalAccountRole1Code accountRole) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "@google.com", value = "Address for electronic mail (e-mail).")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "9999 88 54", value = "Collection of information that identifies a phone number, as defined by telecom services.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "9999 88 54", value = "Collection of information that identifies a mobile phone number, as defined by telecom services.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(partyId, partyNumber, partyType, name, fullLegalName, legalStructure, beneficialOwnership, accountRole, emailAddress, phone, mobile, relationships, address, additionalProperties);
  }

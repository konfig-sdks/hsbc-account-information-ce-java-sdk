...
public class OBReadConsent1Data {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "test value", value = "Specified start date and time for the transaction query period. If this is not populated, the start date will be open ended, and data will be returned from the earliest available transaction.All dates in the JSON payloads are represented in ISO 8601 date-time format.  All date-time fields in responses must include the timezone. An example is below: 2017-04-05T10:43:07+00:00")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(permissions, expirationDateTime, transactionFromDateTime, transactionToDateTime, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if ((jsonObj.get("TransactionFromDateTime") != null && !jsonObj.get("TransactionFromDateTime").isJsonNull()) && !jsonObj.get("TransactionFromDateTime").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `TransactionFromDateTime` to be a primitive type in the JSON string but got `%s`", jsonObj.get("TransactionFromDateTime").toString()));
      }
  }

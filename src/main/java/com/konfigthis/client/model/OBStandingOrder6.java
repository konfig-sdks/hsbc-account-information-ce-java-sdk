...
public class OBStandingOrder6 {
  ...
  **/
   ...
   * @return the OBStandingOrder6 instance itself
   */
  public OBStandingOrder6 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountId, obStandingOrder6.accountId) &&
        ...
        Objects.equals(this.additionalProperties, obStandingOrder6.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to OBStandingOrder6
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OBStandingOrder6.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OBStandingOrder6 is not found in the empty JSON string", OBStandingOrder6.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OBStandingOrder6.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OBStandingOrder6.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OBStandingOrder6' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OBStandingOrder6> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OBStandingOrder6.class));

       return (TypeAdapter<T>) new TypeAdapter<OBStandingOrder6>() {
           @Override
           public void write(JsonWriter out, OBStandingOrder6 value) throws IOException {
           ...
           @Override
           public OBStandingOrder6 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OBStandingOrder6 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OBStandingOrder6 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OBStandingOrder6
  * @throws IOException if the JSON string is invalid with respect to OBStandingOrder6
  */
  public static OBStandingOrder6 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OBStandingOrder6.class);
  }

 /**
  * Convert an instance of OBStandingOrder6 to an JSON string
  *
  * @return JSON string
  */

 ...
 */
@ApiModel(description = "Meta Data relevant to the payload")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Meta {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2023-01-04T13:21:59Z", value = "All dates in the JSON payloads are represented in ISO 8601 date-time format.  All date-time fields in responses must include the timezone. An example is below: 2017-04-05T10:43:07+00:00")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(totalPages, firstAvailableDateTime, lastAvailableDateTime, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("FirstAvailableDateTime");
    openapiFields.add("LastAvailableDateTime");

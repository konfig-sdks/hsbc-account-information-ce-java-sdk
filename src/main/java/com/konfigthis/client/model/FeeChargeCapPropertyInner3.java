...
import com.konfigthis.client.model.OtherFeeTypeProperty6Inner1;
...
public class FeeChargeCapPropertyInner3 {
  /**
 ...
 public enum CappingPeriodEnum {
  ...
  private List<OtherFeeTypeProperty6Inner1> otherFeeType = null;

  public FeeChargeCapPropertyInner3() {
  }

  public FeeChargeCapPropertyInner3 feeType(List<FeeTypeEnum> feeType) {
  ...
  public FeeChargeCapPropertyInner3 addFeeTypeItem(FeeTypeEnum feeTypeItem) {
  ...
  **/
  ...
  public FeeChargeCapPropertyInner3 minMaxType(MinMaxTypeEnum minMaxType) {
  ...
  **/
  ...
  public FeeChargeCapPropertyInner3 feeCapOccurrence(Float feeCapOccurrence) {
  ...
  **/
  ...
  @ApiModelProperty(example = "0.12", value = "fee/charges are captured dependent on the number of occurrences rather than capped at a particular amount")
  ...
  public FeeChargeCapPropertyInner3 feeCapAmount(String feeCapAmount) {
  ...
  **/
  ...
  public FeeChargeCapPropertyInner3 cappingPeriod(CappingPeriodEnum cappingPeriod) {
  ...
  **/
  ...
  public FeeChargeCapPropertyInner3 notes(List<String> notes) {
  ...
  public FeeChargeCapPropertyInner3 addNotesItem(String notesItem) {
    if (this.notes == null) {
  ...
  **/
  ...
  public FeeChargeCapPropertyInner3 otherFeeType(List<OtherFeeTypeProperty6Inner1> otherFeeType) {
  ...
  public FeeChargeCapPropertyInner3 addOtherFeeTypeItem(OtherFeeTypeProperty6Inner1 otherFeeTypeItem) {
  ...
  **/
  ...
  public List<OtherFeeTypeProperty6Inner1> getOtherFeeType() {
    return otherFeeType;
  }


  public void setOtherFeeType(List<OtherFeeTypeProperty6Inner1> otherFeeType) {
   ...
   * @return the FeeChargeCapPropertyInner3 instance itself
   */
  public FeeChargeCapPropertyInner3 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FeeChargeCapPropertyInner3 feeChargeCapPropertyInner3 = (FeeChargeCapPropertyInner3) o;
    return Objects.equals(this.feeType, feeChargeCapPropertyInner3.feeType) &&
        Objects.equals(this.minMaxType, feeChargeCapPropertyInner3.minMaxType) &&
        Objects.equals(this.feeCapOccurrence, feeChargeCapPropertyInner3.feeCapOccurrence) &&
        Objects.equals(this.feeCapAmount, feeChargeCapPropertyInner3.feeCapAmount) &&
        Objects.equals(this.cappingPeriod, feeChargeCapPropertyInner3.cappingPeriod) &&
        Objects.equals(this.notes, feeChargeCapPropertyInner3.notes) &&
        Objects.equals(this.otherFeeType, feeChargeCapPropertyInner3.otherFeeType)&&
        Objects.equals(this.additionalProperties, feeChargeCapPropertyInner3.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FeeChargeCapPropertyInner3 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FeeChargeCapPropertyInner3
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FeeChargeCapPropertyInner3.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FeeChargeCapPropertyInner3 is not found in the empty JSON string", FeeChargeCapPropertyInner3.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FeeChargeCapPropertyInner3.openapiRequiredFields) {
      ...
      if (jsonObj.get("OtherFeeType") != null && !jsonObj.get("OtherFeeType").isJsonNull()) {
        ...
        if (jsonArrayotherFeeType != null) {
          ...
          for (int i = 0; i < jsonArrayotherFeeType.size(); i++) {
            OtherFeeTypeProperty6Inner1.validateJsonObject(jsonArrayotherFeeType.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FeeChargeCapPropertyInner3.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FeeChargeCapPropertyInner3' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FeeChargeCapPropertyInner3> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FeeChargeCapPropertyInner3.class));

       return (TypeAdapter<T>) new TypeAdapter<FeeChargeCapPropertyInner3>() {
           @Override
           public void write(JsonWriter out, FeeChargeCapPropertyInner3 value) throws IOException {
           ...
           @Override
           public FeeChargeCapPropertyInner3 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FeeChargeCapPropertyInner3 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FeeChargeCapPropertyInner3 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FeeChargeCapPropertyInner3
  * @throws IOException if the JSON string is invalid with respect to FeeChargeCapPropertyInner3
  */
  public static FeeChargeCapPropertyInner3 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FeeChargeCapPropertyInner3.class);
  }

 /**
  * Convert an instance of FeeChargeCapPropertyInner3 to an JSON string
  *
  * @return JSON string
  */

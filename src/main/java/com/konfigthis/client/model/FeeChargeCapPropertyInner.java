...
import com.konfigthis.client.model.OtherFeeTypeProperty2Inner;
...
public class FeeChargeCapPropertyInner {
  /**
 ...
 public enum CappingPeriodEnum {
  ...
  private List<OtherFeeTypeProperty2Inner> otherFeeType = null;

  public FeeChargeCapPropertyInner() {
  }

  public FeeChargeCapPropertyInner feeType(List<FeeTypeEnum> feeType) {
  ...
  public FeeChargeCapPropertyInner addFeeTypeItem(FeeTypeEnum feeTypeItem) {
  ...
  **/
  ...
  public FeeChargeCapPropertyInner minMaxType(MinMaxTypeEnum minMaxType) {
  ...
  **/
  ...
  public FeeChargeCapPropertyInner feeCapOccurrence(Float feeCapOccurrence) {
  ...
  **/
  ...
  @ApiModelProperty(example = "0", value = "fee/charges are captured dependent on the number of occurrences rather than capped at a particular amount")
  ...
  public FeeChargeCapPropertyInner feeCapAmount(String feeCapAmount) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "0", value = "Cap amount charged for a fee/charge (where it is charged in terms of an amount rather than a rate)")
  ...
  public FeeChargeCapPropertyInner cappingPeriod(CappingPeriodEnum cappingPeriod) {
  ...
  **/
  ...
  public FeeChargeCapPropertyInner notes(List<String> notes) {
  ...
  public FeeChargeCapPropertyInner addNotesItem(String notesItem) {
    if (this.notes == null) {
  ...
  **/
  ...
  public FeeChargeCapPropertyInner otherFeeType(List<OtherFeeTypeProperty2Inner> otherFeeType) {
  ...
  public FeeChargeCapPropertyInner addOtherFeeTypeItem(OtherFeeTypeProperty2Inner otherFeeTypeItem) {
  ...
  **/
  ...
  public List<OtherFeeTypeProperty2Inner> getOtherFeeType() {
    return otherFeeType;
  }


  public void setOtherFeeType(List<OtherFeeTypeProperty2Inner> otherFeeType) {
   ...
   * @return the FeeChargeCapPropertyInner instance itself
   */
  public FeeChargeCapPropertyInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FeeChargeCapPropertyInner feeChargeCapPropertyInner = (FeeChargeCapPropertyInner) o;
    return Objects.equals(this.feeType, feeChargeCapPropertyInner.feeType) &&
        Objects.equals(this.minMaxType, feeChargeCapPropertyInner.minMaxType) &&
        Objects.equals(this.feeCapOccurrence, feeChargeCapPropertyInner.feeCapOccurrence) &&
        Objects.equals(this.feeCapAmount, feeChargeCapPropertyInner.feeCapAmount) &&
        Objects.equals(this.cappingPeriod, feeChargeCapPropertyInner.cappingPeriod) &&
        Objects.equals(this.notes, feeChargeCapPropertyInner.notes) &&
        Objects.equals(this.otherFeeType, feeChargeCapPropertyInner.otherFeeType)&&
        Objects.equals(this.additionalProperties, feeChargeCapPropertyInner.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FeeChargeCapPropertyInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FeeChargeCapPropertyInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FeeChargeCapPropertyInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FeeChargeCapPropertyInner is not found in the empty JSON string", FeeChargeCapPropertyInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FeeChargeCapPropertyInner.openapiRequiredFields) {
      ...
      if (jsonObj.get("OtherFeeType") != null && !jsonObj.get("OtherFeeType").isJsonNull()) {
        ...
        if (jsonArrayotherFeeType != null) {
          ...
          for (int i = 0; i < jsonArrayotherFeeType.size(); i++) {
            OtherFeeTypeProperty2Inner.validateJsonObject(jsonArrayotherFeeType.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FeeChargeCapPropertyInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FeeChargeCapPropertyInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FeeChargeCapPropertyInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FeeChargeCapPropertyInner.class));

       return (TypeAdapter<T>) new TypeAdapter<FeeChargeCapPropertyInner>() {
           @Override
           public void write(JsonWriter out, FeeChargeCapPropertyInner value) throws IOException {
           ...
           @Override
           public FeeChargeCapPropertyInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FeeChargeCapPropertyInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FeeChargeCapPropertyInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FeeChargeCapPropertyInner
  * @throws IOException if the JSON string is invalid with respect to FeeChargeCapPropertyInner
  */
  public static FeeChargeCapPropertyInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FeeChargeCapPropertyInner.class);
  }

 /**
  * Convert an instance of FeeChargeCapPropertyInner to an JSON string
  *
  * @return JSON string
  */

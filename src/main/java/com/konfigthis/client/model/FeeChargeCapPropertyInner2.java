...
import com.konfigthis.client.model.OtherFeeTypeProperty6Inner;
...
public class FeeChargeCapPropertyInner2 {
  /**
 ...
 public enum CappingPeriodEnum {
  ...
  private List<OtherFeeTypeProperty6Inner> otherFeeType = null;

  public FeeChargeCapPropertyInner2() {
  }

  public FeeChargeCapPropertyInner2 feeType(List<FeeTypeEnum> feeType) {
  ...
  public FeeChargeCapPropertyInner2 addFeeTypeItem(FeeTypeEnum feeTypeItem) {
  ...
  **/
  ...
  public FeeChargeCapPropertyInner2 minMaxType(MinMaxTypeEnum minMaxType) {
  ...
  **/
  ...
  public FeeChargeCapPropertyInner2 feeCapOccurrence(Float feeCapOccurrence) {
  ...
  **/
  ...
  public FeeChargeCapPropertyInner2 feeCapAmount(String feeCapAmount) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "0.34", value = "Cap amount charged for a fee/charge (where it is charged in terms of an amount rather than a rate)")
  ...
  public FeeChargeCapPropertyInner2 cappingPeriod(CappingPeriodEnum cappingPeriod) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "ACADEMICTERM", value = "Period e.g. day, week, month etc. for which the fee/charge is capped")
  ...
  public FeeChargeCapPropertyInner2 notes(List<String> notes) {
  ...
  public FeeChargeCapPropertyInner2 addNotesItem(String notesItem) {
    if (this.notes == null) {
  ...
  **/
  ...
  public FeeChargeCapPropertyInner2 otherFeeType(List<OtherFeeTypeProperty6Inner> otherFeeType) {
  ...
  public FeeChargeCapPropertyInner2 addOtherFeeTypeItem(OtherFeeTypeProperty6Inner otherFeeTypeItem) {
  ...
  **/
  ...
  public List<OtherFeeTypeProperty6Inner> getOtherFeeType() {
    return otherFeeType;
  }


  public void setOtherFeeType(List<OtherFeeTypeProperty6Inner> otherFeeType) {
   ...
   * @return the FeeChargeCapPropertyInner2 instance itself
   */
  public FeeChargeCapPropertyInner2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FeeChargeCapPropertyInner2 feeChargeCapPropertyInner2 = (FeeChargeCapPropertyInner2) o;
    return Objects.equals(this.feeType, feeChargeCapPropertyInner2.feeType) &&
        Objects.equals(this.minMaxType, feeChargeCapPropertyInner2.minMaxType) &&
        Objects.equals(this.feeCapOccurrence, feeChargeCapPropertyInner2.feeCapOccurrence) &&
        Objects.equals(this.feeCapAmount, feeChargeCapPropertyInner2.feeCapAmount) &&
        Objects.equals(this.cappingPeriod, feeChargeCapPropertyInner2.cappingPeriod) &&
        Objects.equals(this.notes, feeChargeCapPropertyInner2.notes) &&
        Objects.equals(this.otherFeeType, feeChargeCapPropertyInner2.otherFeeType)&&
        Objects.equals(this.additionalProperties, feeChargeCapPropertyInner2.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FeeChargeCapPropertyInner2 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FeeChargeCapPropertyInner2
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FeeChargeCapPropertyInner2.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FeeChargeCapPropertyInner2 is not found in the empty JSON string", FeeChargeCapPropertyInner2.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FeeChargeCapPropertyInner2.openapiRequiredFields) {
      ...
      if (jsonObj.get("OtherFeeType") != null && !jsonObj.get("OtherFeeType").isJsonNull()) {
        ...
        if (jsonArrayotherFeeType != null) {
          ...
          for (int i = 0; i < jsonArrayotherFeeType.size(); i++) {
            OtherFeeTypeProperty6Inner.validateJsonObject(jsonArrayotherFeeType.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FeeChargeCapPropertyInner2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FeeChargeCapPropertyInner2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FeeChargeCapPropertyInner2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FeeChargeCapPropertyInner2.class));

       return (TypeAdapter<T>) new TypeAdapter<FeeChargeCapPropertyInner2>() {
           @Override
           public void write(JsonWriter out, FeeChargeCapPropertyInner2 value) throws IOException {
           ...
           @Override
           public FeeChargeCapPropertyInner2 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FeeChargeCapPropertyInner2 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FeeChargeCapPropertyInner2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FeeChargeCapPropertyInner2
  * @throws IOException if the JSON string is invalid with respect to FeeChargeCapPropertyInner2
  */
  public static FeeChargeCapPropertyInner2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FeeChargeCapPropertyInner2.class);
  }

 /**
  * Convert an instance of FeeChargeCapPropertyInner2 to an JSON string
  *
  * @return JSON string
  */

...
public class OBReadOffer1DataOfferInner {
  ...
  **/
  ...
  @ApiModelProperty(example = "LmMGx7nPxh9xkS0KT-OQ7w", value = "A unique and immutable identifier used to identify the offer resource. This identifier has no meaning to the account owner.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "BALANCETRANSFER", value = "Offer type, in a coded form.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "test description", value = "Further details of the offer.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2022-11-15T03:45:02Z", value = "Date and time at which the offer starts.All dates in the JSON payloads are represented in ISO 8601 date-time format.  All date-time fields in responses must include the timezone. An example is below: 2017-04-05T10:43:07+00:00")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2022-11-15T03:45:02Z", value = "Date and time at which the offer ends.All dates in the JSON payloads are represented in ISO 8601 date-time format.  All date-time fields in responses must include the timezone. An example is below: 2017-04-05T10:43:07+00:00")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "test rate", value = "Rate associated with the offer type.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "more details", value = "Further details of the term of the offer.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountId, offerId, offerType, description, startDateTime, endDateTime, rate, value, term, URL, amount, fee, additionalProperties);
  }

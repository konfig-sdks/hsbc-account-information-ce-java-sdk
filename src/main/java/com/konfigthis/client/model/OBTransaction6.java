...
public class OBTransaction6 {
  ...
  **/
  ...
  @ApiModelProperty(example = "0432023004141005879040000-0326P10000000000000010000000000000010000000000OBP", value = "Unique identifier for the transaction within an servicing institution. This identifier is both unique and immutable.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "example TransactionReference", value = "Unique reference for the transaction. This reference is optionally populated, and may as an example be the FPID in the Faster Payments context.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "2023-01-04T13:22:20Z", required = true, value = "Date and time when a transaction entry is posted to an account on the account servicer's books. Usage: Booking date is the expected booking date, unless the status is booked, in which case it is the actual booking date.All dates in the JSON payloads are represented in ISO 8601 date-time format.  All date-time fields in responses must include the timezone. An example is below: 2017-04-05T10:43:07+00:00")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "example TransactionInformation", value = "Further details of the transaction.  This is the transaction narrative, which is unstructured text.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "17 Dean's Yard, Westminster, London", value = "Information that locates and identifies a specific address for a transaction entry, that is presented in free format text.")
  ...
  **/
   ...
   * @return the OBTransaction6 instance itself
   */
  public OBTransaction6 putAdditionalProperty(String key, Object value) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to OBTransaction6
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OBTransaction6.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OBTransaction6 is not found in the empty JSON string", OBTransaction6.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OBTransaction6.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OBTransaction6.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OBTransaction6' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OBTransaction6> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OBTransaction6.class));

       return (TypeAdapter<T>) new TypeAdapter<OBTransaction6>() {
           @Override
           public void write(JsonWriter out, OBTransaction6 value) throws IOException {
           ...
           @Override
           public OBTransaction6 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OBTransaction6 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OBTransaction6 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OBTransaction6
  * @throws IOException if the JSON string is invalid with respect to OBTransaction6
  */
  public static OBTransaction6 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OBTransaction6.class);
  }

 /**
  * Convert an instance of OBTransaction6 to an JSON string
  *
  * @return JSON string
  */

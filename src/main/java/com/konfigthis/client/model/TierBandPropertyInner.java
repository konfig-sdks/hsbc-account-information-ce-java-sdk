...
public class TierBandPropertyInner {
  ...
  **/
  ...
  @ApiModelProperty(example = "40180000173916", value = "Unique and unambiguous identification of a  Tier Band for a BCA.")
  ...
  **/
  ...
  @ApiModelProperty(example = "100", required = true, value = "Minimum deposit value for which the credit interest tier applies.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "1000", value = "Maximum deposit value for which the credit interest tier applies.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "MONTHLY", value = "How often is credit interest calculated for the account.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "WEEKLY", required = true, value = "How often is interest applied to the BCA for this tier/band i.e. how often the financial institution pays accumulated interest to the customer's BCA.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "WHOLE", value = "Amount on which Interest applied.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "1,5%", required = true, value = "The annual equivalent rate (AER) is interest that is calculated under the assumption that any interest paid is combined with the original balance and the next interest payment will be based on the slightly higher account balance. Overall, this means that interest can be compounded several times in a year depending on the number of times that interest payments are made.   Read more: Annual Equivalent Rate (AER) http://www.investopedia.com/terms/a/aer.asp#ixzz4gfR7IO1A")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "GROSS", value = "Interest rate types, other than AER, which financial institutions may use to describe the annual interest rate payable to the BCA.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "0.25%", value = "Bank Interest for the BCA product")
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.identification, tierBandPropertyInner.identification) &&
        ...
        Objects.equals(this.AER, tierBandPropertyInner.AER) &&

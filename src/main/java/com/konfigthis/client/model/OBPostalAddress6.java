...
public class OBPostalAddress6 {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "test value", value = "Identification of a division of a large organisation or building.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "example StreetName", value = "Name of a street or thoroughfare.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "24A", value = "Number that identifies the position of a building on a street.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "80-034", value = "Identifier consisting of a group of letters and/or numbers that is added to a postal address to assist the sorting of mail.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "London", value = "Name of a built-up area, with defined boundaries, and a local government.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "test value", value = "Identifies a subdivision of a country such as state, region, county.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "test value", value = "Nation with its own government.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(addressType, department, subDepartment, streetName, buildingNumber, postCode, townName, countrySubDivision, country, addressLine, additionalProperties);
  }

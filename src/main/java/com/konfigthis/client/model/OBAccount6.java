...
import com.konfigthis.client.model.OBAccount6AccountInner;
 ...
 */
@ApiModel(description = "Unambiguous identification of the account to which credit and debit entries are made. The following fields are optional only for accounts that are switched:    * Data.Currency     * Data.AccountType     * Data.AccountSubType  For all other accounts, the fields must be populated by the ASPSP.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class OBAccount6 {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "x5555", value = "Identification of the currency in which the account is held.  Usage: Currency should only be used in case one and the same account number covers several currencies and the initiating party needs to identify which currency needs to be used for settlement on the account.")
  ...
  **/
  ...
  public OBAccount6 switchStatus(OBExternalSwitchStatusCode switchStatus) {
  ...
  **/
   ...
   * @return the OBAccount6 instance itself
   */
  public OBAccount6 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountId, obAccount6.accountId) &&
        ...
        Objects.equals(this.additionalProperties, obAccount6.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to OBAccount6
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OBAccount6.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OBAccount6 is not found in the empty JSON string", OBAccount6.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OBAccount6.openapiRequiredFields) {
      ...
      if (jsonObj.get("Account") != null && !jsonObj.get("Account").isJsonNull()) {
        ...
        if (jsonArrayaccount != null) {
          ...
          for (int i = 0; i < jsonArrayaccount.size(); i++) {
            OBAccount6AccountInner.validateJsonObject(jsonArrayaccount.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OBAccount6.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OBAccount6' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OBAccount6> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OBAccount6.class));

       return (TypeAdapter<T>) new TypeAdapter<OBAccount6>() {
           @Override
           public void write(JsonWriter out, OBAccount6 value) throws IOException {
           ...
           @Override
           public OBAccount6 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OBAccount6 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OBAccount6 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OBAccount6
  * @throws IOException if the JSON string is invalid with respect to OBAccount6
  */
  public static OBAccount6 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OBAccount6.class);
  }

 /**
  * Convert an instance of OBAccount6 to an JSON string
  *
  * @return JSON string
  */

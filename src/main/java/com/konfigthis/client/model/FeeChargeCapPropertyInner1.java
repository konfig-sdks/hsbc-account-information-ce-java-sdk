...
import com.konfigthis.client.model.OtherFeeTypeProperty3Inner;
...
public class FeeChargeCapPropertyInner1 {
 ...
 public enum CappingPeriodEnum {
  ...
  private List<OtherFeeTypeProperty3Inner> otherFeeType = null;
  ...
  **/
  ...
  @ApiModelProperty(example = "3.41234", value = "fee/charges are captured dependent on the number of occurrences rather than capped at a particular amount")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "test value", value = "Cap amount charged for a fee/charge (where it is charged in terms of an amount rather than a rate)")
  ...
  **/
  ...
  public FeeChargeCapPropertyInner1 otherFeeType(List<OtherFeeTypeProperty3Inner> otherFeeType) {
  ...
  public FeeChargeCapPropertyInner1 addOtherFeeTypeItem(OtherFeeTypeProperty3Inner otherFeeTypeItem) {
  ...
  **/
  ...
  public List<OtherFeeTypeProperty3Inner> getOtherFeeType() {
    return otherFeeType;
  }


  public void setOtherFeeType(List<OtherFeeTypeProperty3Inner> otherFeeType) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.feeType, feeChargeCapPropertyInner1.feeType) &&
        ...
        Objects.equals(this.cappingPeriod, feeChargeCapPropertyInner1.cappingPeriod) &&
      ...
      if (jsonObj.get("OtherFeeType") != null && !jsonObj.get("OtherFeeType").isJsonNull()) {
        ...
        if (jsonArrayotherFeeType != null) {
          ...
          for (int i = 0; i < jsonArrayotherFeeType.size(); i++) {
            OtherFeeTypeProperty3Inner.validateJsonObject(jsonArrayotherFeeType.get(i).getAsJsonObject());
          };
        }
      }
  }

...
public class OBParty2AddressInner {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Salzburg", value = "Identifies a subdivision of a country eg, state, region, county.")
  ...
  **/
  ...
  @ApiModelProperty(example = "GB", required = true, value = "Nation with its own government, occupying a particular territory.")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(addressType, addressLine, streetName, buildingNumber, postCode, townName, countrySubDivision, country, additionalProperties);
  }

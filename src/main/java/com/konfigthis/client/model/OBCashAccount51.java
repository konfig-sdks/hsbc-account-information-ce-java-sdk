...
public class OBCashAccount51 {
  ...
  public OBCashAccount51 schemeName(OBExternalAccountIdentification4Code schemeName) {
  ...
  **/
   ...
   * @return the OBCashAccount51 instance itself
   */
  public OBCashAccount51 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.schemeName, obCashAccount51.schemeName) &&
        ...
        Objects.equals(this.additionalProperties, obCashAccount51.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to OBCashAccount51
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OBCashAccount51.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OBCashAccount51 is not found in the empty JSON string", OBCashAccount51.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OBCashAccount51.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OBCashAccount51.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OBCashAccount51' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OBCashAccount51> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OBCashAccount51.class));

       return (TypeAdapter<T>) new TypeAdapter<OBCashAccount51>() {
           @Override
           public void write(JsonWriter out, OBCashAccount51 value) throws IOException {
           ...
           @Override
           public OBCashAccount51 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OBCashAccount51 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OBCashAccount51 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OBCashAccount51
  * @throws IOException if the JSON string is invalid with respect to OBCashAccount51
  */
  public static OBCashAccount51 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OBCashAccount51.class);
  }

 /**
  * Convert an instance of OBCashAccount51 to an JSON string
  *
  * @return JSON string
  */

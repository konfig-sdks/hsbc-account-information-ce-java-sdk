...
public class OBCurrencyExchange5 {
  ...
  **/
  ...
  @ApiModelProperty(example = "EUR", required = true, value = "Currency from which an amount is to be converted in a currency conversion.")
  ...
  **/
  ...
  @ApiModelProperty(example = "USD", value = "Currency into which an amount is to be converted in a currency conversion.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "USD", value = "Currency in which the rate of exchange is expressed in a currency exchange. In the example 1GBP = xxxCUR, the unit currency is GBP.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "7774890001212", value = "Unique identification to unambiguously identify the foreign exchange contract.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(sourceCurrency, targetCurrency, unitCurrency, exchangeRate, contractIdentification, quotationDate, instructedAmount, additionalProperties);
  }

...
import com.konfigthis.client.model.OtherFeeTypeProperty1Inner;
...
public class OverdraftFeeChargeCapPropertyInner2 {
  /**
   * Overdraft fee type
   */
 ...
 public enum CappingPeriodEnum {
  ...
  private List<OtherFeeTypeProperty1Inner> otherFeeType = null;

  public OverdraftFeeChargeCapPropertyInner2() {
  }

  public OverdraftFeeChargeCapPropertyInner2 feeType(List<FeeTypeEnum> feeType) {
  ...
  public OverdraftFeeChargeCapPropertyInner2 addFeeTypeItem(FeeTypeEnum feeTypeItem) {
  ...
  **/
  ...
  public OverdraftFeeChargeCapPropertyInner2 minMaxType(MinMaxTypeEnum minMaxType) {
  ...
  **/
  ...
  public OverdraftFeeChargeCapPropertyInner2 feeCapOccurrence(Float feeCapOccurrence) {
  ...
  **/
  ...
  public OverdraftFeeChargeCapPropertyInner2 feeCapAmount(String feeCapAmount) {
  ...
  **/
  ...
  public OverdraftFeeChargeCapPropertyInner2 cappingPeriod(CappingPeriodEnum cappingPeriod) {
  ...
  **/
  ...
  public OverdraftFeeChargeCapPropertyInner2 notes(List<String> notes) {
  ...
  public OverdraftFeeChargeCapPropertyInner2 addNotesItem(String notesItem) {
    if (this.notes == null) {
  ...
  **/
  ...
  public OverdraftFeeChargeCapPropertyInner2 otherFeeType(List<OtherFeeTypeProperty1Inner> otherFeeType) {
  ...
  public OverdraftFeeChargeCapPropertyInner2 addOtherFeeTypeItem(OtherFeeTypeProperty1Inner otherFeeTypeItem) {
  ...
  **/
  ...
  public List<OtherFeeTypeProperty1Inner> getOtherFeeType() {
    return otherFeeType;
  }


  public void setOtherFeeType(List<OtherFeeTypeProperty1Inner> otherFeeType) {
   ...
   * @return the OverdraftFeeChargeCapPropertyInner2 instance itself
   */
  public OverdraftFeeChargeCapPropertyInner2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OverdraftFeeChargeCapPropertyInner2 overdraftFeeChargeCapPropertyInner2 = (OverdraftFeeChargeCapPropertyInner2) o;
    return Objects.equals(this.feeType, overdraftFeeChargeCapPropertyInner2.feeType) &&
        Objects.equals(this.minMaxType, overdraftFeeChargeCapPropertyInner2.minMaxType) &&
        Objects.equals(this.feeCapOccurrence, overdraftFeeChargeCapPropertyInner2.feeCapOccurrence) &&
        Objects.equals(this.feeCapAmount, overdraftFeeChargeCapPropertyInner2.feeCapAmount) &&
        Objects.equals(this.cappingPeriod, overdraftFeeChargeCapPropertyInner2.cappingPeriod) &&
        Objects.equals(this.notes, overdraftFeeChargeCapPropertyInner2.notes) &&
        Objects.equals(this.otherFeeType, overdraftFeeChargeCapPropertyInner2.otherFeeType)&&
        Objects.equals(this.additionalProperties, overdraftFeeChargeCapPropertyInner2.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class OverdraftFeeChargeCapPropertyInner2 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to OverdraftFeeChargeCapPropertyInner2
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OverdraftFeeChargeCapPropertyInner2.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OverdraftFeeChargeCapPropertyInner2 is not found in the empty JSON string", OverdraftFeeChargeCapPropertyInner2.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OverdraftFeeChargeCapPropertyInner2.openapiRequiredFields) {
      ...
      if (jsonObj.get("OtherFeeType") != null && !jsonObj.get("OtherFeeType").isJsonNull()) {
        ...
        if (jsonArrayotherFeeType != null) {
          ...
          for (int i = 0; i < jsonArrayotherFeeType.size(); i++) {
            OtherFeeTypeProperty1Inner.validateJsonObject(jsonArrayotherFeeType.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OverdraftFeeChargeCapPropertyInner2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OverdraftFeeChargeCapPropertyInner2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OverdraftFeeChargeCapPropertyInner2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OverdraftFeeChargeCapPropertyInner2.class));

       return (TypeAdapter<T>) new TypeAdapter<OverdraftFeeChargeCapPropertyInner2>() {
           @Override
           public void write(JsonWriter out, OverdraftFeeChargeCapPropertyInner2 value) throws IOException {
           ...
           @Override
           public OverdraftFeeChargeCapPropertyInner2 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OverdraftFeeChargeCapPropertyInner2 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OverdraftFeeChargeCapPropertyInner2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OverdraftFeeChargeCapPropertyInner2
  * @throws IOException if the JSON string is invalid with respect to OverdraftFeeChargeCapPropertyInner2
  */
  public static OverdraftFeeChargeCapPropertyInner2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OverdraftFeeChargeCapPropertyInner2.class);
  }

 /**
  * Convert an instance of OverdraftFeeChargeCapPropertyInner2 to an JSON string
  *
  * @return JSON string
  */

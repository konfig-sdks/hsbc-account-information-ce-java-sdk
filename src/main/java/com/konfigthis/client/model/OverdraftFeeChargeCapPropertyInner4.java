...
public class OverdraftFeeChargeCapPropertyInner4 {
  /**
   * Overdraft fee type
   */
 ...
 public enum CappingPeriodEnum {
  ...
  private List<OtherFeeTypeProperty3Inner1> otherFeeType = null;

  public OverdraftFeeChargeCapPropertyInner4() {
  }

  public OverdraftFeeChargeCapPropertyInner4 feeType(List<FeeTypeEnum> feeType) {
  ...
  public OverdraftFeeChargeCapPropertyInner4 addFeeTypeItem(FeeTypeEnum feeTypeItem) {
  ...
  **/
  ...
  public OverdraftFeeChargeCapPropertyInner4 overdraftControlIndicator(Boolean overdraftControlIndicator) {
  ...
  **/
  ...
  public OverdraftFeeChargeCapPropertyInner4 minMaxType(MinMaxTypeEnum minMaxType) {
  ...
  **/
  ...
  public OverdraftFeeChargeCapPropertyInner4 feeCapOccurrence(Float feeCapOccurrence) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "20", value = "fee/charges are captured dependent on the number of occurrences rather than capped at a particular amount")
  ...
  public OverdraftFeeChargeCapPropertyInner4 feeCapAmount(String feeCapAmount) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "5,000.00", value = "Cap amount charged for a fee/charge")
  ...
  public OverdraftFeeChargeCapPropertyInner4 cappingPeriod(CappingPeriodEnum cappingPeriod) {
  ...
  **/
  ...
  public OverdraftFeeChargeCapPropertyInner4 notes(List<String> notes) {
  ...
  public OverdraftFeeChargeCapPropertyInner4 addNotesItem(String notesItem) {
    if (this.notes == null) {
  ...
  **/
  ...
  public OverdraftFeeChargeCapPropertyInner4 otherFeeType(List<OtherFeeTypeProperty3Inner1> otherFeeType) {
  ...
  public OverdraftFeeChargeCapPropertyInner4 addOtherFeeTypeItem(OtherFeeTypeProperty3Inner1 otherFeeTypeItem) {
  ...
  **/
  ...
  public List<OtherFeeTypeProperty3Inner1> getOtherFeeType() {
    return otherFeeType;
  }


  public void setOtherFeeType(List<OtherFeeTypeProperty3Inner1> otherFeeType) {
   ...
   * @return the OverdraftFeeChargeCapPropertyInner4 instance itself
   */
  public OverdraftFeeChargeCapPropertyInner4 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OverdraftFeeChargeCapPropertyInner4 overdraftFeeChargeCapPropertyInner4 = (OverdraftFeeChargeCapPropertyInner4) o;
    return Objects.equals(this.feeType, overdraftFeeChargeCapPropertyInner4.feeType) &&
        Objects.equals(this.overdraftControlIndicator, overdraftFeeChargeCapPropertyInner4.overdraftControlIndicator) &&
        Objects.equals(this.minMaxType, overdraftFeeChargeCapPropertyInner4.minMaxType) &&
        Objects.equals(this.feeCapOccurrence, overdraftFeeChargeCapPropertyInner4.feeCapOccurrence) &&
        Objects.equals(this.feeCapAmount, overdraftFeeChargeCapPropertyInner4.feeCapAmount) &&
        Objects.equals(this.cappingPeriod, overdraftFeeChargeCapPropertyInner4.cappingPeriod) &&
        Objects.equals(this.notes, overdraftFeeChargeCapPropertyInner4.notes) &&
        Objects.equals(this.otherFeeType, overdraftFeeChargeCapPropertyInner4.otherFeeType)&&
        Objects.equals(this.additionalProperties, overdraftFeeChargeCapPropertyInner4.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class OverdraftFeeChargeCapPropertyInner4 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to OverdraftFeeChargeCapPropertyInner4
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OverdraftFeeChargeCapPropertyInner4.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OverdraftFeeChargeCapPropertyInner4 is not found in the empty JSON string", OverdraftFeeChargeCapPropertyInner4.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OverdraftFeeChargeCapPropertyInner4.openapiRequiredFields) {
      ...
      if (jsonObj.get("OtherFeeType") != null && !jsonObj.get("OtherFeeType").isJsonNull()) {
        ...
        if (jsonArrayotherFeeType != null) {
          ...
          for (int i = 0; i < jsonArrayotherFeeType.size(); i++) {
            OtherFeeTypeProperty3Inner1.validateJsonObject(jsonArrayotherFeeType.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OverdraftFeeChargeCapPropertyInner4.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OverdraftFeeChargeCapPropertyInner4' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OverdraftFeeChargeCapPropertyInner4> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OverdraftFeeChargeCapPropertyInner4.class));

       return (TypeAdapter<T>) new TypeAdapter<OverdraftFeeChargeCapPropertyInner4>() {
           @Override
           public void write(JsonWriter out, OverdraftFeeChargeCapPropertyInner4 value) throws IOException {
           ...
           @Override
           public OverdraftFeeChargeCapPropertyInner4 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OverdraftFeeChargeCapPropertyInner4 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OverdraftFeeChargeCapPropertyInner4 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OverdraftFeeChargeCapPropertyInner4
  * @throws IOException if the JSON string is invalid with respect to OverdraftFeeChargeCapPropertyInner4
  */
  public static OverdraftFeeChargeCapPropertyInner4 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OverdraftFeeChargeCapPropertyInner4.class);
  }

 /**
  * Convert an instance of OverdraftFeeChargeCapPropertyInner4 to an JSON string
  *
  * @return JSON string
  */

...
public class TierBandPropertyInner1 {
 ...
 public enum BankInterestRateTypeEnum {
  ...
  private OtherBankInterestTypeProperty1 otherBankInterestType;
  ...
  private OtherApplicationFrequencyProperty4 otherApplicationFrequency;
  ...
  private OtherCalculationFrequencyProperty4 otherCalculationFrequency;

  public TierBandPropertyInner1() {
  }

  public TierBandPropertyInner1 identification(String identification) {
  ...
  **/
  ...
  public TierBandPropertyInner1 tierValueMinimum(String tierValueMinimum) {
  ...
  **/
  ...
  @ApiModelProperty(example = "21,000", required = true, value = "Minimum deposit value for which the credit interest tier applies.")
  ...
  public TierBandPropertyInner1 tierValueMaximum(String tierValueMaximum) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "100,000.00", value = "Maximum deposit value for which the credit interest tier applies.")
  ...
  public TierBandPropertyInner1 calculationFrequency(CalculationFrequencyEnum calculationFrequency) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "HALFYEARLY", value = "How often is credit interest calculated for the account.")
  ...
  public TierBandPropertyInner1 applicationFrequency(ApplicationFrequencyEnum applicationFrequency) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "DAILY", required = true, value = "How often is interest applied to the PCA for this tier/band i.e. how often the financial institution pays accumulated interest to the customer's PCA.")
  ...
  public TierBandPropertyInner1 depositInterestAppliedCoverage(DepositInterestAppliedCoverageEnum depositInterestAppliedCoverage) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "TIERED", value = "Amount on which Interest applied.")
  ...
  public TierBandPropertyInner1 fixedVariableInterestRateType(FixedVariableInterestRateTypeEnum fixedVariableInterestRateType) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "VARIABLE", required = true, value = "Type of interest rate, Fixed or Variable")
  ...
  public TierBandPropertyInner1 AER(String AER) {
  ...
  **/
  ...
  public TierBandPropertyInner1 bankInterestRateType(BankInterestRateTypeEnum bankInterestRateType) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "GROSS", value = "Interest rate types, other than AER, which financial institutions may use to describe the annual interest rate payable to the PCA.")
  ...
  public TierBandPropertyInner1 bankInterestRate(String bankInterestRate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "test value", value = "Bank Interest for the PCA product")
  ...
  public TierBandPropertyInner1 notes(List<String> notes) {
  ...
  public TierBandPropertyInner1 addNotesItem(String notesItem) {
    if (this.notes == null) {
  ...
  **/
  ...
  public TierBandPropertyInner1 otherBankInterestType(OtherBankInterestTypeProperty1 otherBankInterestType) {
  ...
  **/
  ...
  public OtherBankInterestTypeProperty1 getOtherBankInterestType() {
    return otherBankInterestType;
  }


  public void setOtherBankInterestType(OtherBankInterestTypeProperty1 otherBankInterestType) {
  ...
  public TierBandPropertyInner1 otherApplicationFrequency(OtherApplicationFrequencyProperty4 otherApplicationFrequency) {
  ...
  **/
  ...
  public OtherApplicationFrequencyProperty4 getOtherApplicationFrequency() {
    return otherApplicationFrequency;
  }


  public void setOtherApplicationFrequency(OtherApplicationFrequencyProperty4 otherApplicationFrequency) {
  ...
  public TierBandPropertyInner1 otherCalculationFrequency(OtherCalculationFrequencyProperty4 otherCalculationFrequency) {
  ...
  **/
  ...
  public OtherCalculationFrequencyProperty4 getOtherCalculationFrequency() {
    return otherCalculationFrequency;
  }


  public void setOtherCalculationFrequency(OtherCalculationFrequencyProperty4 otherCalculationFrequency) {
   ...
   * @return the TierBandPropertyInner1 instance itself
   */
  public TierBandPropertyInner1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TierBandPropertyInner1 tierBandPropertyInner1 = (TierBandPropertyInner1) o;
    return Objects.equals(this.identification, tierBandPropertyInner1.identification) &&
        Objects.equals(this.tierValueMinimum, tierBandPropertyInner1.tierValueMinimum) &&
        Objects.equals(this.tierValueMaximum, tierBandPropertyInner1.tierValueMaximum) &&
        Objects.equals(this.calculationFrequency, tierBandPropertyInner1.calculationFrequency) &&
        Objects.equals(this.applicationFrequency, tierBandPropertyInner1.applicationFrequency) &&
        Objects.equals(this.depositInterestAppliedCoverage, tierBandPropertyInner1.depositInterestAppliedCoverage) &&
        Objects.equals(this.fixedVariableInterestRateType, tierBandPropertyInner1.fixedVariableInterestRateType) &&
        Objects.equals(this.AER, tierBandPropertyInner1.AER) &&
        Objects.equals(this.bankInterestRateType, tierBandPropertyInner1.bankInterestRateType) &&
        Objects.equals(this.bankInterestRate, tierBandPropertyInner1.bankInterestRate) &&
        Objects.equals(this.notes, tierBandPropertyInner1.notes) &&
        Objects.equals(this.otherBankInterestType, tierBandPropertyInner1.otherBankInterestType) &&
        Objects.equals(this.otherApplicationFrequency, tierBandPropertyInner1.otherApplicationFrequency) &&
        Objects.equals(this.otherCalculationFrequency, tierBandPropertyInner1.otherCalculationFrequency)&&
        Objects.equals(this.additionalProperties, tierBandPropertyInner1.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(identification, tierValueMinimum, tierValueMaximum, calculationFrequency, applicationFrequency, depositInterestAppliedCoverage, fixedVariableInterestRateType, AER, bankInterestRateType, bankInterestRate, notes, otherBankInterestType, otherApplicationFrequency, otherCalculationFrequency, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TierBandPropertyInner1 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to TierBandPropertyInner1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TierBandPropertyInner1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TierBandPropertyInner1 is not found in the empty JSON string", TierBandPropertyInner1.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TierBandPropertyInner1.openapiRequiredFields) {
      ...
      if (jsonObj.get("OtherBankInterestType") != null && !jsonObj.get("OtherBankInterestType").isJsonNull()) {
        OtherBankInterestTypeProperty1.validateJsonObject(jsonObj.getAsJsonObject("OtherBankInterestType"));
      }
      ...
      if (jsonObj.get("OtherApplicationFrequency") != null && !jsonObj.get("OtherApplicationFrequency").isJsonNull()) {
        OtherApplicationFrequencyProperty4.validateJsonObject(jsonObj.getAsJsonObject("OtherApplicationFrequency"));
      }
      ...
      if (jsonObj.get("OtherCalculationFrequency") != null && !jsonObj.get("OtherCalculationFrequency").isJsonNull()) {
        OtherCalculationFrequencyProperty4.validateJsonObject(jsonObj.getAsJsonObject("OtherCalculationFrequency"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TierBandPropertyInner1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TierBandPropertyInner1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TierBandPropertyInner1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TierBandPropertyInner1.class));

       return (TypeAdapter<T>) new TypeAdapter<TierBandPropertyInner1>() {
           @Override
           public void write(JsonWriter out, TierBandPropertyInner1 value) throws IOException {
           ...
           @Override
           public TierBandPropertyInner1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             TierBandPropertyInner1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TierBandPropertyInner1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TierBandPropertyInner1
  * @throws IOException if the JSON string is invalid with respect to TierBandPropertyInner1
  */
  public static TierBandPropertyInner1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TierBandPropertyInner1.class);
  }

 /**
  * Convert an instance of TierBandPropertyInner1 to an JSON string
  *
  * @return JSON string
  */

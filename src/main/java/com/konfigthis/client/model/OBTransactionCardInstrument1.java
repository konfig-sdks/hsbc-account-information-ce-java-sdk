 ...
 */
@ApiModel(description = "Set of elements to describe the card instrument used in the transaction.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class OBTransactionCardInstrument1 {
  ...
  **/
   ...
   * @return the OBTransactionCardInstrument1 instance itself
   */
  public OBTransactionCardInstrument1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.cardSchemeName, obTransactionCardInstrument1.cardSchemeName) &&
        ...
        Objects.equals(this.additionalProperties, obTransactionCardInstrument1.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(cardSchemeName, authorisationType, name, identification, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("CardSchemeName");
    ...
    openapiRequiredFields.add("CardSchemeName");
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to OBTransactionCardInstrument1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OBTransactionCardInstrument1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OBTransactionCardInstrument1 is not found in the empty JSON string", OBTransactionCardInstrument1.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OBTransactionCardInstrument1.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      if (!jsonObj.get("CardSchemeName").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `CardSchemeName` to be a primitive type in the JSON string but got `%s`", jsonObj.get("CardSchemeName").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OBTransactionCardInstrument1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OBTransactionCardInstrument1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OBTransactionCardInstrument1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OBTransactionCardInstrument1.class));

       return (TypeAdapter<T>) new TypeAdapter<OBTransactionCardInstrument1>() {
           @Override
           public void write(JsonWriter out, OBTransactionCardInstrument1 value) throws IOException {
           ...
           @Override
           public OBTransactionCardInstrument1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OBTransactionCardInstrument1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OBTransactionCardInstrument1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OBTransactionCardInstrument1
  * @throws IOException if the JSON string is invalid with respect to OBTransactionCardInstrument1
  */
  public static OBTransactionCardInstrument1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OBTransactionCardInstrument1.class);
  }

 /**
  * Convert an instance of OBTransactionCardInstrument1 to an JSON string
  *
  * @return JSON string
  */

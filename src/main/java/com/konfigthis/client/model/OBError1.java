...
public class OBError1 {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "This action is not allowed on the account type in the request", required = true, value = "A description of the error that occurred. e.g., 'A mandatory field isn't supplied' or 'RequestedExecutionDateTime must be in future' OBIE doesn't standardise this field")

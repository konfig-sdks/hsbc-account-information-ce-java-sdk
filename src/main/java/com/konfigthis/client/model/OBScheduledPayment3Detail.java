...
public class OBScheduledPayment3Detail {
  ...
  **/
   ...
   * @return the OBScheduledPayment3Detail instance itself
   */
  public OBScheduledPayment3Detail putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountId, obScheduledPayment3Detail.accountId) &&
        ...
        Objects.equals(this.additionalProperties, obScheduledPayment3Detail.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to OBScheduledPayment3Detail
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OBScheduledPayment3Detail.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OBScheduledPayment3Detail is not found in the empty JSON string", OBScheduledPayment3Detail.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OBScheduledPayment3Detail.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OBScheduledPayment3Detail.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OBScheduledPayment3Detail' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OBScheduledPayment3Detail> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OBScheduledPayment3Detail.class));

       return (TypeAdapter<T>) new TypeAdapter<OBScheduledPayment3Detail>() {
           @Override
           public void write(JsonWriter out, OBScheduledPayment3Detail value) throws IOException {
           ...
           @Override
           public OBScheduledPayment3Detail read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OBScheduledPayment3Detail instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OBScheduledPayment3Detail given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OBScheduledPayment3Detail
  * @throws IOException if the JSON string is invalid with respect to OBScheduledPayment3Detail
  */
  public static OBScheduledPayment3Detail fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OBScheduledPayment3Detail.class);
  }

 /**
  * Convert an instance of OBScheduledPayment3Detail to an JSON string
  *
  * @return JSON string
  */

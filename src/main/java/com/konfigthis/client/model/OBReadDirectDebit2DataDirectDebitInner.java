...
public class OBReadDirectDebit2DataDirectDebitInner {
  ...
  **/
  ...
  @ApiModelProperty(example = "DDid", value = "A unique and immutable identifier used to identify the direct debit resource. This identifier has no meaning to the account owner.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "40010000010901", required = true, value = "Direct Debit reference. For AUDDIS service users provide Core Reference. For non AUDDIS service users provide Core reference if possible or last used reference.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "ABC", required = true, value = "Name of Service User.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2023-01-04T00:00Z", value = "Date of most recent direct debit collection.All dates in the JSON payloads are represented in ISO 8601 date-time format.  All date-time fields in responses must include the timezone. An example is below: 2017-04-05T10:43:07+00:00")
  ...
  public OBReadDirectDebit2DataDirectDebitInner frequency(FrequencyEnum frequency) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountId, directDebitId, mandateIdentification, directDebitStatusCode, name, previousPaymentDateTime, frequency, previousPaymentAmount, additionalProperties);
  }

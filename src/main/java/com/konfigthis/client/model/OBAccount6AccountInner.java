...
public class OBAccount6AccountInner {
 ...
 public enum SchemeNameEnum {
  ...
  public OBAccount6AccountInner schemeName(SchemeNameEnum schemeName) {
  ...
  **/
  ...
  @ApiModelProperty(example = "UK_OBIE_BBAN", required = true, value = "Name of the identification scheme, in a coded form as published in an external list.")
  ...
  **/
   ...
   * @return the OBAccount6AccountInner instance itself
   */
  public OBAccount6AccountInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.schemeName, obAccount6AccountInner.schemeName) &&
        ...
        Objects.equals(this.additionalProperties, obAccount6AccountInner.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to OBAccount6AccountInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OBAccount6AccountInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OBAccount6AccountInner is not found in the empty JSON string", OBAccount6AccountInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OBAccount6AccountInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OBAccount6AccountInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OBAccount6AccountInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OBAccount6AccountInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OBAccount6AccountInner.class));

       return (TypeAdapter<T>) new TypeAdapter<OBAccount6AccountInner>() {
           @Override
           public void write(JsonWriter out, OBAccount6AccountInner value) throws IOException {
           ...
           @Override
           public OBAccount6AccountInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OBAccount6AccountInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OBAccount6AccountInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OBAccount6AccountInner
  * @throws IOException if the JSON string is invalid with respect to OBAccount6AccountInner
  */
  public static OBAccount6AccountInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OBAccount6AccountInner.class);
  }

 /**
  * Convert an instance of OBAccount6AccountInner to an JSON string
  *
  * @return JSON string
  */

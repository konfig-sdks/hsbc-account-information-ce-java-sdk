...
import com.konfigthis.client.model.OtherApplicationFrequencyProperty6;
import com.konfigthis.client.model.OtherCalculationFrequencyProperty6;
import com.konfigthis.client.model.OtherFeeRateTypeProperty4;
import com.konfigthis.client.model.OtherFeeTypeProperty4;
import com.konfigthis.client.model.OverdraftFeeChargeCapProperty1;
...
public class OverdraftFeeChargeDetailPropertyInner3 {
  /**
   * Overdraft fee type
   */
 ...
 public enum CalculationFrequencyEnum {
  ...
  private OtherFeeTypeProperty4 otherFeeType;
  ...
  private OtherFeeRateTypeProperty4 otherFeeRateType;
  ...
  private OtherApplicationFrequencyProperty6 otherApplicationFrequency;
  ...
  private OtherCalculationFrequencyProperty6 otherCalculationFrequency;
  ...
  private OverdraftFeeChargeCapProperty1 overdraftFeeChargeCap;

  public OverdraftFeeChargeDetailPropertyInner3() {
  }

  public OverdraftFeeChargeDetailPropertyInner3 feeType(FeeTypeEnum feeType) {
  ...
  **/
  ...
  public OverdraftFeeChargeDetailPropertyInner3 overdraftControlIndicator(Boolean overdraftControlIndicator) {
  ...
  **/
  ...
  public OverdraftFeeChargeDetailPropertyInner3 incrementalBorrowingAmount(String incrementalBorrowingAmount) {
  ...
  **/
  ...
  public OverdraftFeeChargeDetailPropertyInner3 feeAmount(String feeAmount) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "1,000.00", value = "Amount charged for an overdraft fee/charge (where it is charged in terms of an amount rather than a rate)")
  ...
  public OverdraftFeeChargeDetailPropertyInner3 feeRate(String feeRate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "0.01", value = "Rate charged for overdraft fee/charge (where it is charged in terms of a rate rather than an amount)")
  ...
  public OverdraftFeeChargeDetailPropertyInner3 feeRateType(FeeRateTypeEnum feeRateType) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "NET", value = "Rate type for overdraft fee/charge (where it is charged in terms of a rate rather than an amount)")
  ...
  public OverdraftFeeChargeDetailPropertyInner3 applicationFrequency(ApplicationFrequencyEnum applicationFrequency) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "DAILY", required = true, value = "Frequency at which the overdraft charge is applied to the account")
  ...
  public OverdraftFeeChargeDetailPropertyInner3 calculationFrequency(CalculationFrequencyEnum calculationFrequency) {
  ...
  **/
  ...
  public OverdraftFeeChargeDetailPropertyInner3 notes(List<String> notes) {
  ...
  public OverdraftFeeChargeDetailPropertyInner3 addNotesItem(String notesItem) {
    if (this.notes == null) {
  ...
  **/
  ...
  public OverdraftFeeChargeDetailPropertyInner3 otherFeeType(OtherFeeTypeProperty4 otherFeeType) {
  ...
  **/
  ...
  public OtherFeeTypeProperty4 getOtherFeeType() {
    return otherFeeType;
  }


  public void setOtherFeeType(OtherFeeTypeProperty4 otherFeeType) {
  ...
  public OverdraftFeeChargeDetailPropertyInner3 otherFeeRateType(OtherFeeRateTypeProperty4 otherFeeRateType) {
  ...
  **/
  ...
  public OtherFeeRateTypeProperty4 getOtherFeeRateType() {
    return otherFeeRateType;
  }


  public void setOtherFeeRateType(OtherFeeRateTypeProperty4 otherFeeRateType) {
  ...
  public OverdraftFeeChargeDetailPropertyInner3 otherApplicationFrequency(OtherApplicationFrequencyProperty6 otherApplicationFrequency) {
  ...
  **/
  ...
  public OtherApplicationFrequencyProperty6 getOtherApplicationFrequency() {
    return otherApplicationFrequency;
  }


  public void setOtherApplicationFrequency(OtherApplicationFrequencyProperty6 otherApplicationFrequency) {
  ...
  public OverdraftFeeChargeDetailPropertyInner3 otherCalculationFrequency(OtherCalculationFrequencyProperty6 otherCalculationFrequency) {
  ...
  **/
  ...
  public OtherCalculationFrequencyProperty6 getOtherCalculationFrequency() {
    return otherCalculationFrequency;
  }


  public void setOtherCalculationFrequency(OtherCalculationFrequencyProperty6 otherCalculationFrequency) {
  ...
  public OverdraftFeeChargeDetailPropertyInner3 overdraftFeeChargeCap(OverdraftFeeChargeCapProperty1 overdraftFeeChargeCap) {
  ...
  **/
  ...
  public OverdraftFeeChargeCapProperty1 getOverdraftFeeChargeCap() {
    return overdraftFeeChargeCap;
  }


  public void setOverdraftFeeChargeCap(OverdraftFeeChargeCapProperty1 overdraftFeeChargeCap) {
   ...
   * @return the OverdraftFeeChargeDetailPropertyInner3 instance itself
   */
  public OverdraftFeeChargeDetailPropertyInner3 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OverdraftFeeChargeDetailPropertyInner3 overdraftFeeChargeDetailPropertyInner3 = (OverdraftFeeChargeDetailPropertyInner3) o;
    return Objects.equals(this.feeType, overdraftFeeChargeDetailPropertyInner3.feeType) &&
        Objects.equals(this.overdraftControlIndicator, overdraftFeeChargeDetailPropertyInner3.overdraftControlIndicator) &&
        Objects.equals(this.incrementalBorrowingAmount, overdraftFeeChargeDetailPropertyInner3.incrementalBorrowingAmount) &&
        Objects.equals(this.feeAmount, overdraftFeeChargeDetailPropertyInner3.feeAmount) &&
        Objects.equals(this.feeRate, overdraftFeeChargeDetailPropertyInner3.feeRate) &&
        Objects.equals(this.feeRateType, overdraftFeeChargeDetailPropertyInner3.feeRateType) &&
        Objects.equals(this.applicationFrequency, overdraftFeeChargeDetailPropertyInner3.applicationFrequency) &&
        Objects.equals(this.calculationFrequency, overdraftFeeChargeDetailPropertyInner3.calculationFrequency) &&
        Objects.equals(this.notes, overdraftFeeChargeDetailPropertyInner3.notes) &&
        Objects.equals(this.otherFeeType, overdraftFeeChargeDetailPropertyInner3.otherFeeType) &&
        Objects.equals(this.otherFeeRateType, overdraftFeeChargeDetailPropertyInner3.otherFeeRateType) &&
        Objects.equals(this.otherApplicationFrequency, overdraftFeeChargeDetailPropertyInner3.otherApplicationFrequency) &&
        Objects.equals(this.otherCalculationFrequency, overdraftFeeChargeDetailPropertyInner3.otherCalculationFrequency) &&
        Objects.equals(this.overdraftFeeChargeCap, overdraftFeeChargeDetailPropertyInner3.overdraftFeeChargeCap)&&
        Objects.equals(this.additionalProperties, overdraftFeeChargeDetailPropertyInner3.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class OverdraftFeeChargeDetailPropertyInner3 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to OverdraftFeeChargeDetailPropertyInner3
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OverdraftFeeChargeDetailPropertyInner3.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OverdraftFeeChargeDetailPropertyInner3 is not found in the empty JSON string", OverdraftFeeChargeDetailPropertyInner3.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OverdraftFeeChargeDetailPropertyInner3.openapiRequiredFields) {
      ...
      if (jsonObj.get("OtherFeeType") != null && !jsonObj.get("OtherFeeType").isJsonNull()) {
        OtherFeeTypeProperty4.validateJsonObject(jsonObj.getAsJsonObject("OtherFeeType"));
      }
      // validate the optional field `OtherFeeRateType`
      if (jsonObj.get("OtherFeeRateType") != null && !jsonObj.get("OtherFeeRateType").isJsonNull()) {
        OtherFeeRateTypeProperty4.validateJsonObject(jsonObj.getAsJsonObject("OtherFeeRateType"));
      }
      ...
      if (jsonObj.get("OtherApplicationFrequency") != null && !jsonObj.get("OtherApplicationFrequency").isJsonNull()) {
        OtherApplicationFrequencyProperty6.validateJsonObject(jsonObj.getAsJsonObject("OtherApplicationFrequency"));
      }
      ...
      if (jsonObj.get("OtherCalculationFrequency") != null && !jsonObj.get("OtherCalculationFrequency").isJsonNull()) {
        OtherCalculationFrequencyProperty6.validateJsonObject(jsonObj.getAsJsonObject("OtherCalculationFrequency"));
      }
      ...
      if (jsonObj.get("OverdraftFeeChargeCap") != null && !jsonObj.get("OverdraftFeeChargeCap").isJsonNull()) {
        OverdraftFeeChargeCapProperty1.validateJsonObject(jsonObj.getAsJsonObject("OverdraftFeeChargeCap"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OverdraftFeeChargeDetailPropertyInner3.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OverdraftFeeChargeDetailPropertyInner3' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OverdraftFeeChargeDetailPropertyInner3> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OverdraftFeeChargeDetailPropertyInner3.class));

       return (TypeAdapter<T>) new TypeAdapter<OverdraftFeeChargeDetailPropertyInner3>() {
           @Override
           public void write(JsonWriter out, OverdraftFeeChargeDetailPropertyInner3 value) throws IOException {
           ...
           @Override
           public OverdraftFeeChargeDetailPropertyInner3 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OverdraftFeeChargeDetailPropertyInner3 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OverdraftFeeChargeDetailPropertyInner3 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OverdraftFeeChargeDetailPropertyInner3
  * @throws IOException if the JSON string is invalid with respect to OverdraftFeeChargeDetailPropertyInner3
  */
  public static OverdraftFeeChargeDetailPropertyInner3 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OverdraftFeeChargeDetailPropertyInner3.class);
  }

 /**
  * Convert an instance of OverdraftFeeChargeDetailPropertyInner3 to an JSON string
  *
  * @return JSON string
  */

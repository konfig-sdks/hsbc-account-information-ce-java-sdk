...
public class OverdraftTierBandSetPropertyInner1 {
  /**
 ...
 public enum OverdraftTypeEnum {
  ...
  private List<OverdraftTierBandPropertyInner1> overdraftTierBand = new ArrayList<>();
  ...
  public OverdraftTierBandSetPropertyInner1() {
  }

  public OverdraftTierBandSetPropertyInner1 tierBandMethod(TierBandMethodEnum tierBandMethod) {
  ...
  **/
  ...
  @ApiModelProperty(example = "Wholee", required = true, value = "The methodology of how overdraft is charged. It can be: 'Whole'  Where the same charge/rate is applied to the entirety of the overdraft balance (where charges are applicable).  'Tiered' Where different charges/rates are applied dependent on overdraft maximum and minimum balance amount tiers defined by the lending financial organisation 'Banded' Where different charges/rates are applied dependent on overdraft maximum and minimum balance amount bands defined by a government organisation.")
  ...
  public OverdraftTierBandSetPropertyInner1 overdraftType(OverdraftTypeEnum overdraftType) {
  ...
  **/
  ...
  @ApiModelProperty(example = "OTHER", value = "An overdraft can either be 'committed' which means that the facility cannot be withdrawn without reasonable notification before it's agreed end date, or 'on demand' which means that the financial institution can demand repayment at any point in time.")
  ...
  public OverdraftTierBandSetPropertyInner1 identification(String identification) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "4005208277148", value = "Unique and unambiguous identification of a  Tier Band for a overdraft product.")
  ...
  public OverdraftTierBandSetPropertyInner1 authorisedIndicator(Boolean authorisedIndicator) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "true", value = "Indicates if the Overdraft is authorised (Y) or unauthorised (N)")
  ...
  public OverdraftTierBandSetPropertyInner1 bufferAmount(String bufferAmount) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "10,000.00 USD", value = "When a customer exceeds their credit limit, a financial institution will not charge the customer unauthorised overdraft charges if they do not exceed by more than the buffer amount. Note: Authorised overdraft charges may still apply.")
  ...
  public OverdraftTierBandSetPropertyInner1 notes(List<String> notes) {
  ...
  public OverdraftTierBandSetPropertyInner1 addNotesItem(String notesItem) {
    if (this.notes == null) {
  ...
  **/
  ...
  public OverdraftTierBandSetPropertyInner1 overdraftTierBand(List<OverdraftTierBandPropertyInner1> overdraftTierBand) {
  ...
  public OverdraftTierBandSetPropertyInner1 addOverdraftTierBandItem(OverdraftTierBandPropertyInner1 overdraftTierBandItem) {
  ...
  **/
  ...
  public List<OverdraftTierBandPropertyInner1> getOverdraftTierBand() {
    return overdraftTierBand;
  }


  public void setOverdraftTierBand(List<OverdraftTierBandPropertyInner1> overdraftTierBand) {
  ...
  public OverdraftTierBandSetPropertyInner1 overdraftFeesCharges(List<OverdraftFeesChargesPropertyInner3> overdraftFeesCharges) {
  ...
  public OverdraftTierBandSetPropertyInner1 addOverdraftFeesChargesItem(OverdraftFeesChargesPropertyInner3 overdraftFeesChargesItem) {
  ...
  **/
   ...
   * @return the OverdraftTierBandSetPropertyInner1 instance itself
   */
  public OverdraftTierBandSetPropertyInner1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OverdraftTierBandSetPropertyInner1 overdraftTierBandSetPropertyInner1 = (OverdraftTierBandSetPropertyInner1) o;
    return Objects.equals(this.tierBandMethod, overdraftTierBandSetPropertyInner1.tierBandMethod) &&
        Objects.equals(this.overdraftType, overdraftTierBandSetPropertyInner1.overdraftType) &&
        Objects.equals(this.identification, overdraftTierBandSetPropertyInner1.identification) &&
        Objects.equals(this.authorisedIndicator, overdraftTierBandSetPropertyInner1.authorisedIndicator) &&
        Objects.equals(this.bufferAmount, overdraftTierBandSetPropertyInner1.bufferAmount) &&
        Objects.equals(this.notes, overdraftTierBandSetPropertyInner1.notes) &&
        Objects.equals(this.overdraftTierBand, overdraftTierBandSetPropertyInner1.overdraftTierBand) &&
        Objects.equals(this.overdraftFeesCharges, overdraftTierBandSetPropertyInner1.overdraftFeesCharges)&&
        Objects.equals(this.additionalProperties, overdraftTierBandSetPropertyInner1.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(tierBandMethod, overdraftType, identification, authorisedIndicator, bufferAmount, notes, overdraftTierBand, overdraftFeesCharges, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class OverdraftTierBandSetPropertyInner1 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to OverdraftTierBandSetPropertyInner1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OverdraftTierBandSetPropertyInner1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OverdraftTierBandSetPropertyInner1 is not found in the empty JSON string", OverdraftTierBandSetPropertyInner1.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OverdraftTierBandSetPropertyInner1.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayoverdraftTierBand.size(); i++) {
        OverdraftTierBandPropertyInner1.validateJsonObject(jsonArrayoverdraftTierBand.get(i).getAsJsonObject());
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OverdraftTierBandSetPropertyInner1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OverdraftTierBandSetPropertyInner1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OverdraftTierBandSetPropertyInner1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OverdraftTierBandSetPropertyInner1.class));

       return (TypeAdapter<T>) new TypeAdapter<OverdraftTierBandSetPropertyInner1>() {
           @Override
           public void write(JsonWriter out, OverdraftTierBandSetPropertyInner1 value) throws IOException {
           ...
           @Override
           public OverdraftTierBandSetPropertyInner1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OverdraftTierBandSetPropertyInner1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OverdraftTierBandSetPropertyInner1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OverdraftTierBandSetPropertyInner1
  * @throws IOException if the JSON string is invalid with respect to OverdraftTierBandSetPropertyInner1
  */
  public static OverdraftTierBandSetPropertyInner1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OverdraftTierBandSetPropertyInner1.class);
  }

 /**
  * Convert an instance of OverdraftTierBandSetPropertyInner1 to an JSON string
  *
  * @return JSON string
  */

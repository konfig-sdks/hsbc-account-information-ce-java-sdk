...
public class OverdraftTierBandPropertyInner {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "0", value = "An annual percentage rate (APR) is the annual rate charged for borrowing or earned through an investment. APR is expressed as a percentage that represents the actual yearly cost of funds over the term of a loan. This includes any fees or additional costs associated with the transaction but does not take compounding into account.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2.2", value = "Specifies the minimum length of a band for a fixed overdraft agreement")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "1.1", value = "Specifies the maximum length of a band for a fixed overdraft agreement")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "DAY", value = "Specifies the period of a fixed length overdraft agreement")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "WHOLE", value = "Refers to which interest rate is applied when interests are tiered. For example, if an overdraft balance is £2k and the interest tiers are:- 0-£500 0.1%, 500-1000 0.2%, 1000-10000 0.5%, then the applicable interest rate could either be 0.5% of the entire balance (since the account balance sits in the top interest tier) or (0.1%*500)+(0.2%*500)+(0.5%*1000). In the 1st situation, we say the interest is applied to the ‘Whole’ of the account balance,  and in the 2nd that it is ‘Tiered’.")
  ...
  **/
  ...
  public OverdraftTierBandPropertyInner overdraftFeesCharges(List<OverdraftFeesChargesPropertyInner> overdraftFeesCharges) {
  ...
  public OverdraftTierBandPropertyInner addOverdraftFeesChargesItem(OverdraftFeesChargesPropertyInner overdraftFeesChargesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.identification, overdraftTierBandPropertyInner.identification) &&
        ...
        Objects.equals(this.agreementLengthMax, overdraftTierBandPropertyInner.agreementLengthMax) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(identification, tierValueMin, tierValueMax, EAR, representativeAPR, agreementLengthMin, agreementLengthMax, agreementPeriod, overdraftInterestChargingCoverage, bankGuaranteedIndicator, notes, overdraftFeesCharges, additionalProperties);
  }

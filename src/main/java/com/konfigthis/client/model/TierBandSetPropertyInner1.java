...
public class TierBandSetPropertyInner1 {
  ...
  **/
  ...
  @ApiModelProperty(example = "TIERED", required = true, value = "The methodology of how credit interest is charged. It can be:-  1. Banded Interest rates are banded. i.e. Increasing rate on whole balance as balance increases.  2. Tiered Interest rates are tiered. i.e. increasing rate for each tier as balance increases, but interest paid on tier fixed for that tier and not on whole balance.  3. Whole The same interest rate is applied irrespective of the PCA balance")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "PAYAWAY", value = "Describes whether accrued interest is payable only to the PCA or to another bank account")
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tierBandMethod, tierBandSetPropertyInner1.tierBandMethod) &&
        Objects.equals(this.calculationMethod, tierBandSetPropertyInner1.calculationMethod) &&

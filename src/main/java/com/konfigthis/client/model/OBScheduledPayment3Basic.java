...
public class OBScheduledPayment3Basic {
  ...
  **/
   ...
   * @return the OBScheduledPayment3Basic instance itself
   */
  public OBScheduledPayment3Basic putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountId, obScheduledPayment3Basic.accountId) &&
        ...
        Objects.equals(this.additionalProperties, obScheduledPayment3Basic.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountId, scheduledPaymentId, scheduledPaymentDateTime, scheduledType, reference, debtorReference, instructedAmount, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to OBScheduledPayment3Basic
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OBScheduledPayment3Basic.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OBScheduledPayment3Basic is not found in the empty JSON string", OBScheduledPayment3Basic.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OBScheduledPayment3Basic.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OBScheduledPayment3Basic.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OBScheduledPayment3Basic' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OBScheduledPayment3Basic> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OBScheduledPayment3Basic.class));

       return (TypeAdapter<T>) new TypeAdapter<OBScheduledPayment3Basic>() {
           @Override
           public void write(JsonWriter out, OBScheduledPayment3Basic value) throws IOException {
           ...
           @Override
           public OBScheduledPayment3Basic read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OBScheduledPayment3Basic instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OBScheduledPayment3Basic given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OBScheduledPayment3Basic
  * @throws IOException if the JSON string is invalid with respect to OBScheduledPayment3Basic
  */
  public static OBScheduledPayment3Basic fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OBScheduledPayment3Basic.class);
  }

 /**
  * Convert an instance of OBScheduledPayment3Basic to an JSON string
  *
  * @return JSON string
  */

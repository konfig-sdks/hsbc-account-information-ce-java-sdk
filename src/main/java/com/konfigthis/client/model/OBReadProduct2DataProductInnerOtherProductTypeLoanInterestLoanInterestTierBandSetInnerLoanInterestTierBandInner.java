...
public class OBReadProduct2DataProductInnerOtherProductTypeLoanInterestLoanInterestTierBandSetInnerLoanInterestTierBandInner {
  ...
  **/
  ...
  @ApiModelProperty(example = "923912485238", value = "Unique and unambiguous identification of a  Tier Band for a SME Loan.")
  ...
  **/
  ...
  @ApiModelProperty(example = "10000", required = true, value = "Minimum loan value for which the loan interest tier applies.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "PACT", required = true, value = "The unit of period (days, weeks, months etc.) of the Minimum Term")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "64", value = "Maximum loan term for which the loan interest tier applies.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "PACT", value = "The unit of period (days, weeks, months etc.) of the Maximum Term")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "example AER", required = true, value = "The annual equivalent rate (AER) is interest that is calculated under the assumption that any interest paid is combined with the original balance and the next interest payment will be based on the slightly higher account balance. Overall, this means that interest can be compounded several times in a year depending on the number of times that interest payments are made.  For SME Loan, this APR is the representative APR which includes any account fees.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "INOT", value = "Interest rate types, other than APR, which financial institutions may use to describe the annual interest rate payable for the SME Loan.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "1", value = "Loan provider Interest for the SME Loan product")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(identification, tierValueMinimum, tierValueMaximum, tierValueMinTerm, minTermPeriod, tierValueMaxTerm, maxTermPeriod, fixedVariableInterestRateType, repAPR, loanProviderInterestRateType, loanProviderInterestRate, notes, otherLoanProviderInterestRateType, loanInterestFeesCharges, additionalProperties);
  }
      ...
      if (jsonObj.get("LoanInterestFeesCharges") != null && !jsonObj.get("LoanInterestFeesCharges").isJsonNull()) {
        ...
        if (jsonArrayloanInterestFeesCharges != null) {
          ...
          for (int i = 0; i < jsonArrayloanInterestFeesCharges.size(); i++) {
            OBReadProduct2DataProductInnerOtherProductTypeLoanInterestLoanInterestTierBandSetInnerLoanInterestTierBandInnerLoanInterestFeesChargesInner.validateJsonObject(jsonArrayloanInterestFeesCharges.get(i).getAsJsonObject());
          };
        }
      }
  }

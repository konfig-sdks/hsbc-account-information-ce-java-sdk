...
public class ApiClient extends ApiClientCustom {
    ...
    private String basePath = "https://sandbox.ob.hsbcnet.com/mock/ce/obie/open-banking/v3.1/aisp";
    private String tokenUrl = "/obie/open-banking/v1.1/oauth2/token";
    ...
    private RetryingOAuth setupOauth(String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        authentications.put("PSUOAuth2Security", oauth);
        return oauth;
    }
    ...
    private void init() {
        ...
        setUserAgent("Konfig/3.1.11/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://sandbox.ob.hsbcnet.com/mock/ce/obie/open-banking/v3.1/aisp)
     ...
     * Set token url
     *
     * @param tokenUrl Token URL for oauth (e.g /obie/open-banking/v1.1/oauth2/token)
     * @return An instance of OkHttpClient
     */

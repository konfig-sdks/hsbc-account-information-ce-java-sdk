...
public class PartiesApiGenerated {
    ...
    private ApiResponse<OBReadParty3> getByAccountIdWithHttpInfo(String accountId, String xFapiAuthDate, String xFapiCustomerIpAddress, String xFapiInteractionId, String xCustomerUserAgent) throws ApiException {
    ...
    private okhttp3.Call getByAccountIdAsync(String accountId, String xFapiAuthDate, String xFapiCustomerIpAddress, String xFapiInteractionId, String xCustomerUserAgent, final ApiCallback<OBReadParty3> _callback) throws ApiException {
    ...
    public class GetByAccountIdRequestBuilder {
        ...
        public OBReadParty3 execute() throws ApiException {
            ApiResponse<OBReadParty3> localVarResp = getByAccountIdWithHttpInfo(accountId, xFapiAuthDate, xFapiCustomerIpAddress, xFapiInteractionId, xCustomerUserAgent);

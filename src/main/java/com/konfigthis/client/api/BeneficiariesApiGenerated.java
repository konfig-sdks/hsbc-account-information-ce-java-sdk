...
public class BeneficiariesApiGenerated {
    ...
    private ApiResponse<OBReadBeneficiary5> getByAccountIdWithHttpInfo(String accountId, String xFapiAuthDate, String xFapiCustomerIpAddress, String xFapiInteractionId, String xCustomerUserAgent) throws ApiException {
    ...
    private okhttp3.Call getByAccountIdAsync(String accountId, String xFapiAuthDate, String xFapiCustomerIpAddress, String xFapiInteractionId, String xCustomerUserAgent, final ApiCallback<OBReadBeneficiary5> _callback) throws ApiException {
    ...
    public class GetByAccountIdRequestBuilder {
        ...
        public OBReadBeneficiary5 execute() throws ApiException {
            ApiResponse<OBReadBeneficiary5> localVarResp = getByAccountIdWithHttpInfo(accountId, xFapiAuthDate, xFapiCustomerIpAddress, xFapiInteractionId, xCustomerUserAgent);
